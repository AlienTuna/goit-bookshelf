 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();var Hp=document.querySelector(".backdrop"),Bp=document.querySelector(".open-modal"),zp=document.querySelector(".form-wrapper"),Kp=document.querySelector(".display-shop");console.dir(Kp),Kp.style.display="none";var Gp=null,Yp=Dt({apiKey:"AIzaSyBoP3LpsEiKYieYZusHkpDBfoZn6Hezx9o",authDomain:"serhii-df24d.firebaseapp.com",projectId:"serhii-df24d",storageBucket:"serhii-df24d.appspot.com",messagingSenderId:"305658302139",appId:"1:305658302139:web:6a7f5004932c7c8c1f639e",measurementId:"G-WNMLVDPVC8"}),Jp=(function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Mt(),t=Pt(e=Le(e),au);t.isInitialized()?t.getImmediate():$u(e)}(Yp),function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Mt(),t=Pt(e,"auth");if(t.isInitialized())return t.getImmediate();var n=jr(e,{popupRedirectResolver:po,persistence:[ha,qi,Vi]}),r=ee("authTokenSyncURL");if(r){var i=To(r);Di(n,i,(function(){return i(n.currentUser)})),Ai(n,(function(e){return i(e)}))}var a=$("auth");return a&&Ur(n,"http://".concat(a)),n}(Yp));console.log(Jp);var Qp=[1,2,3];function $p(){var e;(e=Jp,Le(e).signOut()).then((function(){console.log("Sign-out successful."),Gp.remove(),Bp.textContent="Sign up",Bp.disabled=!1,Kp.style.display="none"})).catch((function(e){console.log(e)}))}function Xp(e){e.preventDefault(),console.dir(e.currentTarget);var t=e.currentTarget.elements,n=t.name,r=t.email,i=t.password;Ni(Jp,r.value,i.value).then((function(e){var t=e.user;console.log(t),function(e){console.log(tv),Op(Np(Wp(),"users/"+Jp.currentUser.uid),{name:e})}(n.value),Hp.classList.add("is-hidden"),nv()})).catch((function(e){e.code,e.message}))}function Zp(e){return ev.apply(this,arguments)}function ev(){return(ev=e(a)(e(o).mark((function t(n){var r,i,a;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n.preventDefault(),console.dir(n.currentTarget),r=n.currentTarget.elements,i=r.email,a=r.password,e.next=5,Oi(Jp,i.value,a.value).then((function(e){e.user;console.log(Jp),nv(),Hp.classList.add("is-hidden")})).catch((function(e){e.code,e.message}));case 5:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function tv(){console.log(tv),Ap(Np(Wp(),"users/"+Jp.currentUser.uid),{books:Qp})}function nv(){Dp(Rp(Np(Wp()),"users/".concat(Jp.currentUser.uid))).then((function(e){e.exists()?(console.log(e.val()),Bp.textContent=e.val().name,Kp.style.display="block"):console.log("No data available")})).catch((function(e){console.error(e)}))}console.log("qwer"),document.querySelector(".cloze").addEventListener("click",(function(){Hp.classList.add("is-hidden")}));var rv,iv,av,ov=document.querySelector(".sign-in"),sv=document.querySelector(".sign-up");function uv(){if("Sign up"!==Bp.textContent)return function(){var e='<button class="log-out">Log out</button>';Bp.insertAdjacentHTML("afterend",e),(Gp=document.querySelector(".log-out")).addEventListener("click",$p)}(),void(Bp.disabled=!0);zp.innerHTML='<form class="auth-form">\n  <input type="text" name="name" placeholder="NAME" />\n  <input type="text" name="email" placeholder="EMAIL" />\n  <input type="text" name="password" placeholder="PASSWORD" />\n  <button type="submit" class="registr">SIGN UP</button>\n  </form>';var e=document.querySelector(".auth-form");Hp.classList.remove("is-hidden"),e.addEventListener("submit",Xp),console.log("openModal")}Bp.addEventListener("click",uv),sv.addEventListener("click",uv),ov.addEventListener("click",(function(){zp.innerHTML='<form class="login-form">\n  <input type="text" name="email" placeholder="EMAIL" />\n  <input type="text" name="password" placeholder="PASSWORD" />\n  <button type="submit" class="login">LOGIN</button>\n  </form>',document.querySelector(".login-form").addEventListener("submit",Zp)})),console.dir(Bp),rv=function(e){e&&(e.uid,console.log(e),nv())},Le(Jp).onAuthStateChanged(rv,iv,av)}();
//# sourceMappingURL=shopping.8a3192ad.js.map
