 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();var Hp=document.querySelector(".backdrop"),Bp=document.querySelector(".open-modal"),zp=document.querySelector(".form-wrapper"),Kp=null,Gp=Dt({apiKey:"AIzaSyBoP3LpsEiKYieYZusHkpDBfoZn6Hezx9o",authDomain:"serhii-df24d.firebaseapp.com",projectId:"serhii-df24d",storageBucket:"serhii-df24d.appspot.com",messagingSenderId:"305658302139",appId:"1:305658302139:web:6a7f5004932c7c8c1f639e",measurementId:"G-WNMLVDPVC8"}),Yp=(function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Mt(),t=Pt(e=Le(e),au);t.isInitialized()?t.getImmediate():$u(e)}(Gp),function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Mt(),t=Pt(e,"auth");if(t.isInitialized())return t.getImmediate();var n=jr(e,{popupRedirectResolver:po,persistence:[ha,qi,Vi]}),r=ee("authTokenSyncURL");if(r){var i=To(r);Di(n,i,(function(){return i(n.currentUser)})),Ai(n,(function(e){return i(e)}))}var a=$("auth");return a&&Ur(n,"http://".concat(a)),n}(Gp)),Jp=[1,2,3];function Qp(){var e;(e=Yp,Le(e).signOut()).then((function(){console.log("Sign-out successful."),Kp.remove(),Bp.textContent="Sign up"})).catch((function(e){console.log(e)}))}function $p(e){e.preventDefault(),console.dir(e.currentTarget);var t=e.currentTarget.elements,n=t.name,r=t.email,i=t.password;Ni(Yp,r.value,i.value).then((function(e){var t=e.user;console.log(t),function(e){console.log(ev),Op(Np(Wp(),"users/"+Yp.currentUser.uid),{name:e})}(n.value),Hp.classList.add("is-hidden")})).catch((function(e){e.code,e.message}))}function Xp(e){return Zp.apply(this,arguments)}function Zp(){return(Zp=e(a)(e(o).mark((function t(n){var r,i,a;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n.preventDefault(),console.dir(n.currentTarget),r=n.currentTarget.elements,i=r.email,a=r.password,e.next=5,Oi(Yp,i.value,a.value).then((function(e){var t=e.user;console.log(t);tv();Hp.classList.add("is-hidden")})).catch((function(e){e.code,e.message}));case 5:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function ev(){console.log(ev),Ap(Np(Wp(),"users/"+Yp.currentUser.uid),{books:Jp})}function tv(){Dp(Rp(Np(Wp()),"users/".concat(Yp.currentUser.uid))).then((function(e){e.exists()?(console.log(e.val()),Bp.textContent=e.val().name):console.log("No data available")})).catch((function(e){console.error(e)}))}document.querySelector(".cloze").addEventListener("click",(function(){Hp.classList.add("is-hidden")}));var nv=document.querySelector(".sign-in"),rv=document.querySelector(".sign-up");function iv(){if("Sign up"===Bp.textContent){zp.innerHTML='<form class="auth-form">\n    <input type="text" name="name" placeholder="name" />\n    <input type="text" name="email" placeholder="email" />\n    <input type="text" name="password" placeholder="password" />\n    <button type="submit" class="registr">Sign up</button>\n  </form>';var e=document.querySelector(".auth-form");Hp.classList.remove("is-hidden"),e.addEventListener("submit",$p),console.log("openModal")}else!function(){var e='<button class="log-out">Log out</button>';Bp.insertAdjacentHTML("afterend",e),(Kp=document.querySelector(".log-out")).addEventListener("click",Qp)}()}Bp.addEventListener("click",iv),rv.addEventListener("click",iv),nv.addEventListener("click",(function(){zp.innerHTML='<form class="login-form">\n    <input type="text" name="email" placeholder="email" />\n    <input type="text" name="password" placeholder="password" />\n    <button type="submit" class="login">Login</button>\n  </form>',document.querySelector(".login-form").addEventListener("submit",Xp)})),iv()}();
//# sourceMappingURL=index.080ebbf9.js.map
