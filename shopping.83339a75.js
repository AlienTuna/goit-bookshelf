 ...
 * limitations under the License.
 */
var El,Sl=function(){"use strict";function t(n,r){e(u)(this,t),this.name=n,this.node=r}return e(c)(t,null,[{key:"Wrap",value:function(e,n){return new t(e,n)}}]),t}(),Pl=function(){"use strict";function t(){e(u)(this,t)}return e(c)(t,[{key:"getCompare",value:function(){return this.compare.bind(this)}},{key:"indexedValueChanged",value:function(e,t){var n=new Sl(xc,e),r=new Sl(xc,t);return 0!==this.compare(n,r)}},{key:"minPost",value:function(){return Sl.MIN}}]),t}(),Nl=function(t){"use strict";e(l)(r,t);var n=e(I)(r);function r(){return e(u)(this,r),n.apply(this,arguments)}return e(c)(r,[{key:"compare",value:function(e,t){return Tc(e.name,t.name)}},{key:"isDefinedOn",value:function(e){throw q("KeyIndex.isDefinedOn not expected to be called.")}},{key:"indexedValueChanged",value:function(e,t){return!1}},{key:"minPost",value:function(){return Sl.MIN}},{key:"maxPost",value:function(){return new Sl(Cc,El)}},{key:"makePost",value:function(e,t){return U("string"==typeof e,"KeyIndex indexValue must always be a string."),new Sl(e,El)}},{key:"toString",value:function(){return".key"}}],[{key:"__EMPTY_NODE",get:function(){return El},set:function(e){El=e}}]),r}(Pl),Rl=new Nl,Ol=function(){"use strict";function t(n,r,i,a){var o=arguments.length>4&&void 0!==arguments[4]?arguments[4]:null;e(u)(this,t),this.isReverse_=a,this.resultGenerator_=o,this.nodeStack_=[];for(var s=1;!n.isEmpty();)if(s=r?i(n.key,r):1,a&&(s*=-1),s<0)n=this.isReverse_?n.left:n.right;else{if(0===s){this.nodeStack_.push(n);break}this.nodeStack_.push(n),n=this.isReverse_?n.right:n.left}}return e(c)(t,[{key:"getNext",value:function(){if(0===this.nodeStack_.length)return null;var e,t=this.nodeStack_.pop();if(e=this.resultGenerator_?this.resultGenerator_(t.key,t.value):{key:t.key,value:t.value},this.isReverse_)for(t=t.left;!t.isEmpty();)this.nodeStack_.push(t),t=t.right;else for(t=t.right;!t.isEmpty();)this.nodeStack_.push(t),t=t.left;return e}},{key:"hasNext",value:function(){return this.nodeStack_.length>0}},{key:"peek",value:function(){if(0===this.nodeStack_.length)return null;var e=this.nodeStack_[this.nodeStack_.length-1];return this.resultGenerator_?this.resultGenerator_(e.key,e.value):{key:e.key,value:e.value}}}]),t}(),Al=function(){"use strict";function t(n,r,i,a,o){e(u)(this,t),this.key=n,this.value=r,this.color=null!=i?i:t.RED,this.left=null!=a?a:Ll.EMPTY_NODE,this.right=null!=o?o:Ll.EMPTY_NODE}return e(c)(t,[{key:"copy",value:function(e,n,r,i,a){return new t(null!=e?e:this.key,null!=n?n:this.value,null!=r?r:this.color,null!=i?i:this.left,null!=a?a:this.right)}},{key:"count",value:function(){return this.left.count()+1+this.right.count()}},{key:"isEmpty",value:function(){return!1}},{key:"inorderTraversal",value:function(e){return this.left.inorderTraversal(e)||!!e(this.key,this.value)||this.right.inorderTraversal(e)}},{key:"reverseTraversal",value:function(e){return this.right.reverseTraversal(e)||e(this.key,this.value)||this.left.reverseTraversal(e)}},{key:"min_",value:function(){return this.left.isEmpty()?this:this.left.min_()}},{key:"minKey",value:function(){return this.min_().key}},{key:"maxKey",value:function(){return this.right.isEmpty()?this.key:this.right.maxKey()}},{key:"insert",value:function(e,t,n){var r=this,i=n(e,r.key);return(r=i<0?r.copy(null,null,null,r.left.insert(e,t,n),null):0===i?r.copy(null,t,null,null,null):r.copy(null,null,null,null,r.right.insert(e,t,n))).fixUp_()}},{key:"removeMin_",value:function(){if(this.left.isEmpty())return Ll.EMPTY_NODE;var e=this;return e.left.isRed_()||e.left.left.isRed_()||(e=e.moveRedLeft_()),(e=e.copy(null,null,null,e.left.removeMin_(),null)).fixUp_()}},{key:"remove",value:function(e,t){var n,r;if(t(e,(n=this).key)<0)n.left.isEmpty()||n.left.isRed_()||n.left.left.isRed_()||(n=n.moveRedLeft_()),n=n.copy(null,null,null,n.left.remove(e,t),null);else{if(n.left.isRed_()&&(n=n.rotateRight_()),n.right.isEmpty()||n.right.isRed_()||n.right.left.isRed_()||(n=n.moveRedRight_()),0===t(e,n.key)){if(n.right.isEmpty())return Ll.EMPTY_NODE;r=n.right.min_(),n=n.copy(r.key,r.value,null,null,n.right.removeMin_())}n=n.copy(null,null,null,null,n.right.remove(e,t))}return n.fixUp_()}},{key:"isRed_",value:function(){return this.color}},{key:"fixUp_",value:function(){var e=this;return e.right.isRed_()&&!e.left.isRed_()&&(e=e.rotateLeft_()),e.left.isRed_()&&e.left.left.isRed_()&&(e=e.rotateRight_()),e.left.isRed_()&&e.right.isRed_()&&(e=e.colorFlip_()),e}},{key:"moveRedLeft_",value:function(){var e=this.colorFlip_();return e.right.left.isRed_()&&(e=(e=(e=e.copy(null,null,null,null,e.right.rotateRight_())).rotateLeft_()).colorFlip_()),e}},{key:"moveRedRight_",value:function(){var e=this.colorFlip_();return e.left.left.isRed_()&&(e=(e=e.rotateRight_()).colorFlip_()),e}},{key:"rotateLeft_",value:function(){var e=this.copy(null,null,t.RED,null,this.right.left);return this.right.copy(null,null,this.color,e,null)}},{key:"rotateRight_",value:function(){var e=this.copy(null,null,t.RED,this.left.right,null);return this.left.copy(null,null,this.color,null,e)}},{key:"colorFlip_",value:function(){var e=this.left.copy(null,null,!this.left.color,null,null),t=this.right.copy(null,null,!this.right.color,null,null);return this.copy(null,null,!this.color,e,t)}},{key:"checkMaxDepth_",value:function(){var e=this.check_();return Math.pow(2,e)<=this.count()+1}},{key:"check_",value:function(){if(this.isRed_()&&this.left.isRed_())throw new Error("Red node has red child("+this.key+","+this.value+")");if(this.right.isRed_())throw new Error("Right child of ("+this.key+","+this.value+") is red");var e=this.left.check_();if(e!==this.right.check_())throw new Error("Black depths differ");return e+(this.isRed_()?0:1)}}]),t}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Al.RED=!0,Al.BLACK=!1;var Dl,Ml=function(){"use strict";function t(){e(u)(this,t)}return e(c)(t,[{key:"copy",value:function(e,t,n,r,i){return this}},{key:"insert",value:function(e,t,n){return new Al(e,t,null)}},{key:"remove",value:function(e,t){return this}},{key:"count",value:function(){return 0}},{key:"isEmpty",value:function(){return!0}},{key:"inorderTraversal",value:function(e){return!1}},{key:"reverseTraversal",value:function(e){return!1}},{key:"minKey",value:function(){return null}},{key:"maxKey",value:function(){return null}},{key:"check_",value:function(){return 0}},{key:"isRed_",value:function(){return!1}}]),t}(),Ll=function(){"use strict";function t(n){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:t.EMPTY_NODE;e(u)(this,t),this.comparator_=n,this.root_=r}return e(c)(t,[{key:"insert",value:function(e,n){return new t(this.comparator_,this.root_.insert(e,n,this.comparator_).copy(null,null,Al.BLACK,null,null))}},{key:"remove",value:function(e){return new t(this.comparator_,this.root_.remove(e,this.comparator_).copy(null,null,Al.BLACK,null,null))}},{key:"get",value:function(e){for(var t,n=this.root_;!n.isEmpty();){if(0===(t=this.comparator_(e,n.key)))return n.value;t<0?n=n.left:t>0&&(n=n.right)}return null}},{key:"getPredecessorKey",value:function(e){for(var t,n=this.root_,r=null;!n.isEmpty();){if(0===(t=this.comparator_(e,n.key))){if(n.left.isEmpty())return r?r.key:null;for(n=n.left;!n.right.isEmpty();)n=n.right;return n.key}t<0?n=n.left:t>0&&(r=n,n=n.right)}throw new Error("Attempted to find predecessor key for a nonexistent key.  What gives?")}},{key:"isEmpty",value:function(){return this.root_.isEmpty()}},{key:"count",value:function(){return this.root_.count()}},{key:"minKey",value:function(){return this.root_.minKey()}},{key:"maxKey",value:function(){return this.root_.maxKey()}},{key:"inorderTraversal",value:function(e){return this.root_.inorderTraversal(e)}},{key:"reverseTraversal",value:function(e){return this.root_.reverseTraversal(e)}},{key:"getIterator",value:function(e){return new Ol(this.root_,null,this.comparator_,!1,e)}},{key:"getIteratorFrom",value:function(e,t){return new Ol(this.root_,e,this.comparator_,!1,t)}},{key:"getReverseIteratorFrom",value:function(e,t){return new Ol(this.root_,e,this.comparator_,!0,t)}},{key:"getReverseIterator",value:function(e){return new Ol(this.root_,null,this.comparator_,!0,e)}}]),t}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Fl(e,t){return Tc(e.name,t.name)}function jl(e,t){return Tc(e,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ll.EMPTY_NODE=new Ml;var Ul,ql,Wl,Vl=function(e){return"number"==typeof e?"number:"+Oc(e):"string:"+e},Hl=function(e){if(e.isLeafNode()){var t=e.val();U("string"==typeof t||"number"==typeof t||"object"==typeof t&&_e(t,".sv"),"Priority must be a string or number.")}else U(e===Dl||e.isEmpty(),"priority of unexpected type.");U(e===Dl||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")},Bl=function(){"use strict";function t(n){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:t.__childrenNodeConstructor.EMPTY_NODE;e(u)(this,t),this.value_=n,this.priorityNode_=r,this.lazyHash_=null,U(void 0!==this.value_&&null!==this.value_,"LeafNode shouldn't be created with null/undefined value."),Hl(this.priorityNode_)}return e(c)(t,[{key:"isLeafNode",value:function(){return!0}},{key:"getPriority",value:function(){return this.priorityNode_}},{key:"updatePriority",value:function(e){return new t(this.value_,e)}},{key:"getImmediateChild",value:function(e){return".priority"===e?this.priorityNode_:t.__childrenNodeConstructor.EMPTY_NODE}},{key:"getChild",value:function(e){return ml(e)?this:".priority"===ll(e)?this.priorityNode_:t.__childrenNodeConstructor.EMPTY_NODE}},{key:"hasChild",value:function(){return!1}},{key:"getPredecessorChildName",value:function(e,t){return null}},{key:"updateImmediateChild",value:function(e,n){return".priority"===e?this.updatePriority(n):n.isEmpty()&&".priority"!==e?this:t.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,n).updatePriority(this.priorityNode_)}},{key:"updateChild",value:function(e,n){var r=ll(e);return null===r?n:n.isEmpty()&&".priority"!==r?this:(U(".priority"!==r||1===hl(e),".priority must be the last token in a path"),this.updateImmediateChild(r,t.__childrenNodeConstructor.EMPTY_NODE.updateChild(fl(e),n)))}},{key:"isEmpty",value:function(){return!1}},{key:"numChildren",value:function(){return 0}},{key:"forEachChild",value:function(e,t){return!1}},{key:"val",value:function(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}},{key:"hash",value:function(){if(null===this.lazyHash_){var t="";this.priorityNode_.isEmpty()||(t+="priority:"+Vl(this.priorityNode_.val())+":");var n=e(tc)(this.value_);t+=n+":",t+="number"===n?Oc(this.value_):this.value_,this.lazyHash_=dc(t)}return this.lazyHash_}},{key:"getValue",value:function(){return this.value_}},{key:"compareTo",value:function(e){return e===t.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof t.__childrenNodeConstructor?-1:(U(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}},{key:"compareToLeafNode_",value:function(n){var r=e(tc)(n.value_),i=e(tc)(this.value_),a=t.VALUE_TYPE_ORDER.indexOf(r),o=t.VALUE_TYPE_ORDER.indexOf(i);return U(a>=0,"Unknown leaf type: "+r),U(o>=0,"Unknown leaf type: "+i),a===o?"object"===i?0:this.value_<n.value_?-1:this.value_===n.value_?0:1:o-a}},{key:"withIndex",value:function(){return this}},{key:"isIndexed",value:function(){return!0}},{key:"equals",value:function(e){if(e===this)return!0;if(e.isLeafNode()){var t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}return!1}}],[{key:"__childrenNodeConstructor",get:function(){return Ul},set:function(e){Ul=e}}]),t}();Bl.VALUE_TYPE_ORDER=["object","boolean","number","string"];var zl,Kl,Gl=function(t){"use strict";e(l)(r,t);var n=e(I)(r);function r(){return e(u)(this,r),n.apply(this,arguments)}return e(c)(r,[{key:"compare",value:function(e,t){var n=e.node.getPriority(),r=t.node.getPriority(),i=n.compareTo(r);return 0===i?Tc(e.name,t.name):i}},{key:"isDefinedOn",value:function(e){return!e.getPriority().isEmpty()}},{key:"indexedValueChanged",value:function(e,t){return!e.getPriority().equals(t.getPriority())}},{key:"minPost",value:function(){return Sl.MIN}},{key:"maxPost",value:function(){return new Sl(Cc,new Bl("[PRIORITY-POST]",Wl))}},{key:"makePost",value:function(e,t){var n=ql(e);return new Sl(t,new Bl("[PRIORITY-POST]",n))}},{key:"toString",value:function(){return".priority"}}]),r}(Pl),Yl=new Gl,Jl=Math.log(2),Ql=function(){"use strict";function t(n){e(u)(this,t);var r;this.count=(r=n+1,parseInt(Math.log(r)/Jl,10)),this.current_=this.count-1;var i,a=(i=this.count,parseInt(Array(i+1).join("1"),2));this.bits_=n+1&a}return e(c)(t,[{key:"nextBitIsOne",value:function(){var e=!(this.bits_&1<<this.current_);return this.current_--,e}}]),t}(),$l=function(e,t,n,r){e.sort(t);var i=function(t,r){var a,o,s=r-t;if(0===s)return null;if(1===s)return a=e[t],o=n?n(a):a,new Al(o,a.node,Al.BLACK,null,null);var u=parseInt(s/2,10)+t,c=i(t,u),l=i(u+1,r);return a=e[u],o=n?n(a):a,new Al(o,a.node,Al.BLACK,c,l)},a=function(t){for(var r=null,a=null,o=e.length,s=function(t,r){var a=o-t,s=o;o-=t;var c=i(a+1,s),l=e[a],h=n?n(l):l;u(new Al(h,l.node,r,null,c))},u=function(e){r?(r.left=e,r=e):(a=e,r=e)},c=0;c<t.count;++c){var l=t.nextBitIsOne(),h=Math.pow(2,t.count-(c+1));l?s(h,Al.BLACK):(s(h,Al.BLACK),s(h,Al.RED))}return a}(new Ql(e.length));return new Ll(r||t,a)},Xl={},Zl=function(){"use strict";function t(n,r){e(u)(this,t),this.indexes_=n,this.indexSet_=r}return e(c)(t,[{key:"get",value:function(e){var t=ke(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Ll?t:null}},{key:"hasIndex",value:function(e){return _e(this.indexSet_,e.toString())}},{key:"addIndex",value:function(e,n){U(e!==Rl,"KeyIndex always exists and isn't meant to be added to the IndexMap.");for(var r,i=[],a=!1,o=n.getIterator(Sl.Wrap),s=o.getNext();s;)a=a||e.isDefinedOn(s.node),i.push(s),s=o.getNext();r=a?$l(i,e.getCompare()):Xl;var u=e.toString(),c=Object.assign({},this.indexSet_);c[u]=e;var l=Object.assign({},this.indexes_);return l[u]=r,new t(l,c)}},{key:"addToIndexes",value:function(e,n){var r=this;return new t(we(this.indexes_,(function(t,i){var a=ke(r.indexSet_,i);if(U(a,"Missing index implementation for "+i),t===Xl){if(a.isDefinedOn(e.node)){for(var o=[],s=n.getIterator(Sl.Wrap),u=s.getNext();u;)u.name!==e.name&&o.push(u),u=s.getNext();return o.push(e),$l(o,a.getCompare())}return Xl}var c=n.get(e.name),l=t;return c&&(l=l.remove(new Sl(e.name,c))),l.insert(e,e.node)})),this.indexSet_)}},{key:"removeFromIndexes",value:function(e,n){return new t(we(this.indexes_,(function(t){if(t===Xl)return t;var r=n.get(e.name);return r?t.remove(new Sl(e.name,r)):t})),this.indexSet_)}}],[{key:"Default",get:function(){return U(Xl&&Yl,"ChildrenNode.ts has not been loaded"),zl=zl||new t({".priority":Xl},{".priority":Yl})}}]),t}(),eh=function(){"use strict";function t(n,r,i){e(u)(this,t),this.children_=n,this.priorityNode_=r,this.indexMap_=i,this.lazyHash_=null,this.priorityNode_&&Hl(this.priorityNode_),this.children_.isEmpty()&&U(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}return e(c)(t,[{key:"isLeafNode",value:function(){return!1}},{key:"getPriority",value:function(){return this.priorityNode_||Kl}},{key:"updatePriority",value:function(e){return this.children_.isEmpty()?this:new t(this.children_,e,this.indexMap_)}},{key:"getImmediateChild",value:function(e){if(".priority"===e)return this.getPriority();var t=this.children_.get(e);return null===t?Kl:t}},{key:"getChild",value:function(e){var t=ll(e);return null===t?this:this.getImmediateChild(t).getChild(fl(e))}},{key:"hasChild",value:function(e){return null!==this.children_.get(e)}},{key:"updateImmediateChild",value:function(e,n){if(U(n,"We should always be passing snapshot nodes"),".priority"===e)return this.updatePriority(n);var r,i,a=new Sl(e,n);n.isEmpty()?(r=this.children_.remove(e),i=this.indexMap_.removeFromIndexes(a,this.children_)):(r=this.children_.insert(e,n),i=this.indexMap_.addToIndexes(a,this.children_));var o=r.isEmpty()?Kl:this.priorityNode_;return new t(r,o,i)}},{key:"updateChild",value:function(e,t){var n=ll(e);if(null===n)return t;U(".priority"!==ll(e)||1===hl(e),".priority must be the last token in a path");var r=this.getImmediateChild(n).updateChild(fl(e),t);return this.updateImmediateChild(n,r)}},{key:"isEmpty",value:function(){return this.children_.isEmpty()}},{key:"numChildren",value:function(){return this.children_.count()}},{key:"val",value:function(e){if(this.isEmpty())return null;var n={},r=0,i=0,a=!0;if(this.forEachChild(Yl,(function(o,s){n[o]=s.val(e),r++,a&&t.INTEGER_REGEXP_.test(o)?i=Math.max(i,Number(o)):a=!1})),!e&&a&&i<2*r){var o=[];for(var s in n)o[s]=n[s];return o}return e&&!this.getPriority().isEmpty()&&(n[".priority"]=this.getPriority().val()),n}},{key:"hash",value:function(){if(null===this.lazyHash_){var e="";this.getPriority().isEmpty()||(e+="priority:"+Vl(this.getPriority().val())+":"),this.forEachChild(Yl,(function(t,n){var r=n.hash();""!==r&&(e+=":"+t+":"+r)})),this.lazyHash_=""===e?"":dc(e)}return this.lazyHash_}},{key:"getPredecessorChildName",value:function(e,t,n){var r=this.resolveIndex_(n);if(r){var i=r.getPredecessorKey(new Sl(e,t));return i?i.name:null}return this.children_.getPredecessorKey(e)}},{key:"getFirstChildName",value:function(e){var t=this.resolveIndex_(e);if(t){var n=t.minKey();return n&&n.name}return this.children_.minKey()}},{key:"getFirstChild",value:function(e){var t=this.getFirstChildName(e);return t?new Sl(t,this.children_.get(t)):null}},{key:"getLastChildName",value:function(e){var t=this.resolveIndex_(e);if(t){var n=t.maxKey();return n&&n.name}return this.children_.maxKey()}},{key:"getLastChild",value:function(e){var t=this.getLastChildName(e);return t?new Sl(t,this.children_.get(t)):null}},{key:"forEachChild",value:function(e,t){var n=this.resolveIndex_(e);return n?n.inorderTraversal((function(e){return t(e.name,e.node)})):this.children_.inorderTraversal(t)}},{key:"getIterator",value:function(e){return this.getIteratorFrom(e.minPost(),e)}},{key:"getIteratorFrom",value:function(e,t){var n=this.resolveIndex_(t);if(n)return n.getIteratorFrom(e,(function(e){return e}));for(var r=this.children_.getIteratorFrom(e.name,Sl.Wrap),i=r.peek();null!=i&&t.compare(i,e)<0;)r.getNext(),i=r.peek();return r}},{key:"getReverseIterator",value:function(e){return this.getReverseIteratorFrom(e.maxPost(),e)}},{key:"getReverseIteratorFrom",value:function(e,t){var n=this.resolveIndex_(t);if(n)return n.getReverseIteratorFrom(e,(function(e){return e}));for(var r=this.children_.getReverseIteratorFrom(e.name,Sl.Wrap),i=r.peek();null!=i&&t.compare(i,e)>0;)r.getNext(),i=r.peek();return r}},{key:"compareTo",value:function(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===th?-1:0}},{key:"withIndex",value:function(e){if(e===Rl||this.indexMap_.hasIndex(e))return this;var n=this.indexMap_.addIndex(e,this.children_);return new t(this.children_,this.priorityNode_,n)}},{key:"isIndexed",value:function(e){return e===Rl||this.indexMap_.hasIndex(e)}},{key:"equals",value:function(e){if(e===this)return!0;if(e.isLeafNode())return!1;var t=e;if(this.getPriority().equals(t.getPriority())){if(this.children_.count()===t.children_.count()){for(var n=this.getIterator(Yl),r=t.getIterator(Yl),i=n.getNext(),a=r.getNext();i&&a;){if(i.name!==a.name||!i.node.equals(a.node))return!1;i=n.getNext(),a=r.getNext()}return null===i&&null===a}return!1}return!1}},{key:"resolveIndex_",value:function(e){return e===Rl?null:this.indexMap_.get(e.toString())}}],[{key:"EMPTY_NODE",get:function(){return Kl||(Kl=new t(new Ll(jl),null,Zl.Default))}}]),t}();eh.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;var th=new(function(t){"use strict";e(l)(r,t);var n=e(I)(r);function r(){return e(u)(this,r),n.call(this,new Ll(jl),eh.EMPTY_NODE,Zl.Default)}return e(c)(r,[{key:"compareTo",value:function(e){return e===this?0:1}},{key:"equals",value:function(e){return e===this}},{key:"getPriority",value:function(){return this}},{key:"getImmediateChild",value:function(e){return eh.EMPTY_NODE}},{key:"isEmpty",value:function(){return!1}}]),r}(eh));Object.defineProperties(Sl,{MIN:{value:new Sl(xc,eh.EMPTY_NODE)},MAX:{value:new Sl(Cc,th)}}),Nl.__EMPTY_NODE=eh.EMPTY_NODE,Bl.__childrenNodeConstructor=eh,Dl=th,function(e){Wl=e}(th);function nh(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;if(null===t)return eh.EMPTY_NODE;if("object"==typeof t&&".priority"in t&&(n=t[".priority"]),U(null===n||"string"==typeof n||"number"==typeof n||"object"==typeof n&&".sv"in n,"Invalid priority type found: "+(void 0===n?"undefined":e(tc)(n))),"object"==typeof t&&".value"in t&&null!==t[".value"]&&(t=t[".value"]),"object"!=typeof t||".sv"in t){var r=t;return new Bl(r,nh(n))}if(t instanceof Array){var i=eh.EMPTY_NODE;return Rc(t,(function(e,n){if(_e(t,e)&&"."!==e.substring(0,1)){var r=nh(n);!r.isLeafNode()&&r.isEmpty()||(i=i.updateImmediateChild(e,r))}})),i.updatePriority(nh(n))}var a=[],o=!1,s=t;if(Rc(s,(function(e,t){if("."!==e.substring(0,1)){var n=nh(t);n.isEmpty()||(o=o||!n.getPriority().isEmpty(),a.push(new Sl(e,n)))}})),0===a.length)return eh.EMPTY_NODE;var u=$l(a,Fl,(function(e){return e.name}),jl);if(o){var c=$l(a,Yl.getCompare());return new eh(u,nh(n),new Zl({".priority":c},{".priority":Yl}))}return new eh(u,nh(n),Zl.Default)}!function(e){ql=e}(nh);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function oh(e){return{type:"value",snapshotNode:e}}function sh(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function uh(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function ch(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
var lh=function(){"use strict";function t(n){e(u)(this,t),this.index_=n}return e(c)(t,[{key:"updateChild",value:function(e,t,n,r,i,a){U(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");var o=e.getImmediateChild(t);return o.getChild(r).equals(n.getChild(r))&&o.isEmpty()===n.isEmpty()?e:(null!=a&&(n.isEmpty()?e.hasChild(t)?a.trackChildChange(uh(t,o)):U(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):o.isEmpty()?a.trackChildChange(sh(t,n)):a.trackChildChange(ch(t,n,o))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))}},{key:"updateFullNode",value:function(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(Yl,(function(e,r){t.hasChild(e)||n.trackChildChange(uh(e,r))})),t.isLeafNode()||t.forEachChild(Yl,(function(t,r){if(e.hasChild(t)){var i=e.getImmediateChild(t);i.equals(r)||n.trackChildChange(ch(t,r,i))}else n.trackChildChange(sh(t,r))}))),t.withIndex(this.index_)}},{key:"updatePriority",value:function(e,t){return e.isEmpty()?eh.EMPTY_NODE:e.updatePriority(t)}},{key:"filtersNodes",value:function(){return!1}},{key:"getIndexedFilter",value:function(){return this}},{key:"getIndex",value:function(){return this.index_}}]),t}(),hh=function(){"use strict";function t(n){e(u)(this,t),this.indexedFilter_=new lh(n.getIndex()),this.index_=n.getIndex(),this.startPost_=t.getStartPost_(n),this.endPost_=t.getEndPost_(n),this.startIsInclusive_=!n.startAfterSet_,this.endIsInclusive_=!n.endBeforeSet_}return e(c)(t,[{key:"getStartPost",value:function(){return this.startPost_}},{key:"getEndPost",value:function(){return this.endPost_}},{key:"matches",value:function(e){var t=this.startIsInclusive_?this.index_.compare(this.getStartPost(),e)<=0:this.index_.compare(this.getStartPost(),e)<0,n=this.endIsInclusive_?this.index_.compare(e,this.getEndPost())<=0:this.index_.compare(e,this.getEndPost())<0;return t&&n}},{key:"updateChild",value:function(e,t,n,r,i,a){return this.matches(new Sl(t,n))||(n=eh.EMPTY_NODE),this.indexedFilter_.updateChild(e,t,n,r,i,a)}},{key:"updateFullNode",value:function(e,t,n){t.isLeafNode()&&(t=eh.EMPTY_NODE);var r=t.withIndex(this.index_);r=r.updatePriority(eh.EMPTY_NODE);var i=this;return t.forEachChild(Yl,(function(e,t){i.matches(new Sl(e,t))||(r=r.updateImmediateChild(e,eh.EMPTY_NODE))})),this.indexedFilter_.updateFullNode(e,r,n)}},{key:"updatePriority",value:function(e,t){return e}},{key:"filtersNodes",value:function(){return!0}},{key:"getIndexedFilter",value:function(){return this.indexedFilter_}},{key:"getIndex",value:function(){return this.index_}}],[{key:"getStartPost_",value:function(e){if(e.hasStart()){var t=e.getIndexStartName();return e.getIndex().makePost(e.getIndexStartValue(),t)}return e.getIndex().minPost()}},{key:"getEndPost_",value:function(e){if(e.hasEnd()){var t=e.getIndexEndName();return e.getIndex().makePost(e.getIndexEndValue(),t)}return e.getIndex().maxPost()}}]),t}(),fh=function(){"use strict";function t(n){var r=this;e(u)(this,t),this.withinDirectionalStart=function(e){return r.reverse_?r.withinEndPost(e):r.withinStartPost(e)},this.withinDirectionalEnd=function(e){return r.reverse_?r.withinStartPost(e):r.withinEndPost(e)},this.withinStartPost=function(e){var t=r.index_.compare(r.rangedFilter_.getStartPost(),e);return r.startIsInclusive_?t<=0:t<0},this.withinEndPost=function(e){var t=r.index_.compare(e,r.rangedFilter_.getEndPost());return r.endIsInclusive_?t<=0:t<0},this.rangedFilter_=new hh(n),this.index_=n.getIndex(),this.limit_=n.getLimit(),this.reverse_=!n.isViewFromLeft(),this.startIsInclusive_=!n.startAfterSet_,this.endIsInclusive_=!n.endBeforeSet_}return e(c)(t,[{key:"updateChild",value:function(e,t,n,r,i,a){return this.rangedFilter_.matches(new Sl(t,n))||(n=eh.EMPTY_NODE),e.getImmediateChild(t).equals(n)?e:e.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(e,t,n,r,i,a):this.fullLimitUpdateChild_(e,t,n,i,a)}},{key:"updateFullNode",value:function(e,t,n){var r;if(t.isLeafNode()||t.isEmpty())r=eh.EMPTY_NODE.withIndex(this.index_);else if(2*this.limit_<t.numChildren()&&t.isIndexed(this.index_)){var i;r=eh.EMPTY_NODE.withIndex(this.index_),i=this.reverse_?t.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):t.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);for(var a=0;i.hasNext()&&a<this.limit_;){var o=i.getNext();if(this.withinDirectionalStart(o)){if(!this.withinDirectionalEnd(o))break;r=r.updateImmediateChild(o.name,o.node),a++}}}else{var s;r=(r=t.withIndex(this.index_)).updatePriority(eh.EMPTY_NODE),s=this.reverse_?r.getReverseIterator(this.index_):r.getIterator(this.index_);for(var u=0;s.hasNext();){var c=s.getNext();u<this.limit_&&this.withinDirectionalStart(c)&&this.withinDirectionalEnd(c)?u++:r=r.updateImmediateChild(c.name,eh.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(e,r,n)}},{key:"updatePriority",value:function(e,t){return e}},{key:"filtersNodes",value:function(){return!0}},{key:"getIndexedFilter",value:function(){return this.rangedFilter_.getIndexedFilter()}},{key:"getIndex",value:function(){return this.index_}},{key:"fullLimitUpdateChild_",value:function(e,t,n,r,i){var a;if(this.reverse_){var o=this.index_.getCompare();a=function(e,t){return o(t,e)}}else a=this.index_.getCompare();var s=e;U(s.numChildren()===this.limit_,"");var u=new Sl(t,n),c=this.reverse_?s.getFirstChild(this.index_):s.getLastChild(this.index_),l=this.rangedFilter_.matches(u);if(s.hasChild(t)){for(var h=s.getImmediateChild(t),f=r.getChildAfterChild(this.index_,c,this.reverse_);null!=f&&(f.name===t||s.hasChild(f.name));)f=r.getChildAfterChild(this.index_,f,this.reverse_);var d=null==f?1:a(f,u);if(l&&!n.isEmpty()&&d>=0)return null!=i&&i.trackChildChange(ch(t,n,h)),s.updateImmediateChild(t,n);null!=i&&i.trackChildChange(uh(t,h));var p=s.updateImmediateChild(t,eh.EMPTY_NODE);return null!=f&&this.rangedFilter_.matches(f)?(null!=i&&i.trackChildChange(sh(f.name,f.node)),p.updateImmediateChild(f.name,f.node)):p}return n.isEmpty()?e:l&&a(c,u)>=0?(null!=i&&(i.trackChildChange(uh(c.name,c.node)),i.trackChildChange(sh(t,n))),s.updateImmediateChild(t,n).updateImmediateChild(c.name,eh.EMPTY_NODE)):e}}]),t}(),dh=function(){"use strict";function t(){e(u)(this,t),this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=Yl}return e(c)(t,[{key:"hasStart",value:function(){return this.startSet_}},{key:"isViewFromLeft",value:function(){return""===this.viewFrom_?this.startSet_:"l"===this.viewFrom_}},{key:"getIndexStartValue",value:function(){return U(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}},{key:"getIndexStartName",value:function(){return U(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:xc}},{key:"hasEnd",value:function(){return this.endSet_}},{key:"getIndexEndValue",value:function(){return U(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}},{key:"getIndexEndName",value:function(){return U(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:Cc}},{key:"hasLimit",value:function(){return this.limitSet_}},{key:"hasAnchoredLimit",value:function(){return this.limitSet_&&""!==this.viewFrom_}},{key:"getLimit",value:function(){return U(this.limitSet_,"Only valid if limit has been set"),this.limit_}},{key:"getIndex",value:function(){return this.index_}},{key:"loadsAllData",value:function(){return!(this.startSet_||this.endSet_||this.limitSet_)}},{key:"isDefault",value:function(){return this.loadsAllData()&&this.index_===Yl}},{key:"copy",value:function(){var e=new t;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}]),t}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ph(e){var t,n={};if(e.isDefault())return n;if(e.index_===Yl?t="$priority":e.index_===ah?t="$value":e.index_===Rl?t="$key":(U(e.index_ instanceof rh,"Unrecognized index type!"),t=e.index_.toString()),n.orderBy=ye(t),e.startSet_){var r=e.startAfterSet_?"startAfter":"startAt";n[r]=ye(e.indexStartValue_),e.startNameSet_&&(n[r]+=","+ye(e.indexStartName_))}if(e.endSet_){var i=e.endBeforeSet_?"endBefore":"endAt";n[i]=ye(e.indexEndValue_),e.endNameSet_&&(n[i]+=","+ye(e.indexEndName_))}return e.limitSet_&&(e.isViewFromLeft()?n.limitToFirst=e.limit_:n.limitToLast=e.limit_),n}function vh(e){var t={};if(e.startSet_&&(t.sp=e.indexStartValue_,e.startNameSet_&&(t.sn=e.indexStartName_),t.sin=!e.startAfterSet_),e.endSet_&&(t.ep=e.indexEndValue_,e.endNameSet_&&(t.en=e.indexEndName_),t.ein=!e.endBeforeSet_),e.limitSet_){t.l=e.limit_;var n=e.viewFrom_;""===n&&(n=e.isViewFromLeft()?"l":"r"),t.vf=n}return e.index_!==Yl&&(t.i=e.index_.toString()),t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var yh=function(t){"use strict";e(l)(r,t);var n=e(I)(r);function r(t,i,a,o){var s;return e(u)(this,r),(s=n.call(this)).repoInfo_=t,s.onDataUpdate_=i,s.authTokenProvider_=a,s.appCheckTokenProvider_=o,s.log_=_c("p:rest:"),s.listens_={},s}return e(c)(r,[{key:"reportStats",value:function(e){throw new Error("Method not implemented.")}},{key:"listen",value:function(e,t,n,i){var a=this,o=e._path.toString();this.log_("Listen called for "+o+" "+e._queryIdentifier);var s=r.getListenId_(e,n),u={};this.listens_[s]=u;var c=ph(e._queryParams);this.restRequest_(o+".json",c,(function(e,t){var r=t;(404===e&&(r=null,e=null),null===e&&a.onDataUpdate_(o,r,!1,n),ke(a.listens_,s)===u)&&i(e?401===e?"permission_denied":"rest_error:"+e:"ok",null)}))}},{key:"unlisten",value:function(e,t){var n=r.getListenId_(e,t);delete this.listens_[n]}},{key:"get",value:function(e){var t=this,n=ph(e._queryParams),r=e._path.toString(),i=new te;return this.restRequest_(r+".json",n,(function(e,n){var a=n;404===e&&(a=null,e=null),null===e?(t.onDataUpdate_(r,a,!1,null),i.resolve(a)):i.reject(new Error(a))})),i.promise}},{key:"refreshAuthToken",value:function(e){}},{key:"restRequest_",value:function(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=arguments.length>2?arguments[2]:void 0,i=this;return n.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((function(a){var o=e(h)(a,2),s=o[0],u=o[1],c=i;s&&s.accessToken&&(n.auth=s.accessToken),u&&u.token&&(n.ac=u.token);var l=(i.repoInfo_.secure?"https://":"http://")+i.repoInfo_.host+t+"?ns="+i.repoInfo_.namespace+Ce(n);i.log_("Sending REST request for "+l);var f=new XMLHttpRequest;f.onreadystatechange=function(){if(r&&4===f.readyState){c.log_("REST Response for "+l+" received. status:",f.status,"response:",f.responseText);var e=null;if(f.status>=200&&f.status<300){try{e=ve(f.responseText)}catch(e){wc("Failed to parse JSON response for "+l+": "+f.responseText)}r(null,e)}else 401!==f.status&&404!==f.status&&wc("Got unsuccessful REST response for "+l+" Status: "+f.status),r(f.status);r=null}},f.open("GET",l,!0),f.send()}))}}],[{key:"getListenId_",value:function(e,t){return void 0!==t?"tag$"+t:(U(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}}]),r}(al),mh=function(){"use strict";function t(){e(u)(this,t),this.rootNode_=eh.EMPTY_NODE}return e(c)(t,[{key:"getNode",value:function(e){return this.rootNode_.getChild(e)}},{key:"updateSnapshot",value:function(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}]),t}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function gh(){return{value:null,children:new Map}}function _h(e,t,n){if(ml(t))e.value=n,e.children.clear();else if(null!==e.value)e.value=e.value.updateChild(t,n);else{var r=ll(t);e.children.has(r)||e.children.set(r,gh()),_h(e.children.get(r),t=fl(t),n)}}function kh(e,t,n){null!==e.value?n(t,e.value):function(e,t){e.children.forEach((function(e,n){t(n,e)}))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,(function(e,r){kh(r,new ul(t.toString()+"/"+e),n)}))}var bh,wh,Ih=function(){"use strict";function t(n){e(u)(this,t),this.collection_=n,this.last_=null}return e(c)(t,[{key:"get",value:function(){var e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Rc(this.last_,(function(e,n){t[e]=t[e]-n})),this.last_=e,t}}]),t}(),xh=function(){"use strict";function t(n,r){e(u)(this,t),this.server_=r,this.statsToReport_={},this.statsListener_=new Ih(n);var i=1e4+2e4*Math.random();Lc(this.reportStats_.bind(this),Math.floor(i))}return e(c)(t,[{key:"reportStats_",value:function(){var e=this,t=this.statsListener_.get(),n={},r=!1;Rc(t,(function(t,i){i>0&&_e(e.statsToReport_,t)&&(n[t]=i,r=!0)})),r&&this.server_.reportStats(n),Lc(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}}]),t}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(wh=bh||(bh={}))[wh.OVERWRITE=0]="OVERWRITE",wh[wh.MERGE=1]="MERGE",wh[wh.ACK_USER_WRITE=2]="ACK_USER_WRITE",wh[wh.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";var Th,Eh=function(){"use strict";function t(n,r,i){e(u)(this,t),this.path=n,this.affectedTree=r,this.revert=i,this.type=bh.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}return e(c)(t,[{key:"operationForChild",value:function(e){if(ml(this.path)){if(null!=this.affectedTree.value)return U(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;var n=this.affectedTree.subtree(new ul(e));return new t(cl(),n,this.revert)}return U(ll(this.path)===e,"operationForChild called for unrelated child."),new t(fl(this.path),this.affectedTree,this.revert)}}]),t}(),Sh=function(){"use strict";function t(n,r){e(u)(this,t),this.source=n,this.path=r,this.type=bh.LISTEN_COMPLETE}return e(c)(t,[{key:"operationForChild",value:function(e){return ml(this.path)?new t(this.source,cl()):new t(this.source,fl(this.path))}}]),t}(),Ph=function(){"use strict";function t(n,r,i){e(u)(this,t),this.source=n,this.path=r,this.snap=i,this.type=bh.OVERWRITE}return e(c)(t,[{key:"operationForChild",value:function(e){return ml(this.path)?new t(this.source,cl(),this.snap.getImmediateChild(e)):new t(this.source,fl(this.path),this.snap)}}]),t}(),Nh=function(){"use strict";function t(n,r,i){e(u)(this,t),this.source=n,this.path=r,this.children=i,this.type=bh.MERGE}return e(c)(t,[{key:"operationForChild",value:function(e){if(ml(this.path)){var n=this.children.subtree(new ul(e));return n.isEmpty()?null:n.value?new Ph(this.source,cl(),n.value):new t(this.source,cl(),n)}return U(ll(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new t(this.source,fl(this.path),this.children)}},{key:"toString",value:function(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}]),t}(),Rh=function(){"use strict";function t(n,r,i){e(u)(this,t),this.node_=n,this.fullyInitialized_=r,this.filtered_=i}return e(c)(t,[{key:"isFullyInitialized",value:function(){return this.fullyInitialized_}},{key:"isFiltered",value:function(){return this.filtered_}},{key:"isCompleteForPath",value:function(e){if(ml(e))return this.isFullyInitialized()&&!this.filtered_;var t=ll(e);return this.isCompleteForChild(t)}},{key:"isCompleteForChild",value:function(e){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(e)}},{key:"getNode",value:function(){return this.node_}}]),t}(),Oh=function t(n){"use strict";e(u)(this,t),this.query_=n,this.index_=this.query_._queryParams.getIndex()};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ah(e,t,n,r,i,a){var o=r.filter((function(e){return e.type===n}));o.sort((function(t,n){return function(e,t,n){if(null==t.childName||null==n.childName)throw q("Should only compare child_ events.");var r=new Sl(t.childName,t.snapshotNode),i=new Sl(n.childName,n.snapshotNode);return e.index_.compare(r,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n)})),o.forEach((function(n){var r=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,a);i.forEach((function(i){i.respondsTo(n.type)&&t.push(i.createEvent(r,e.query_))}))}))}function Dh(e,t){return{eventCache:e,serverCache:t}}function Mh(e,t,n,r){return Dh(new Rh(t,n,r),e.serverCache)}function Lh(e,t,n,r){return Dh(e.eventCache,new Rh(t,n,r))}function Fh(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function jh(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xh(e,t){return df(t,e)}function Zh(e,t){for(var n=0;n<e.allWrites.length;n++){var r=e.allWrites[n];if(r.writeId===t)return r}return null}function ef(e,t){var n=e.allWrites.findIndex((function(e){return e.writeId===t}));U(n>=0,"removeWrite called with nonexistent writeId.");var r=e.allWrites[n];e.allWrites.splice(n,1);for(var i=r.visible,a=!1,o=e.allWrites.length-1;i&&o>=0;){var s=e.allWrites[o];s.visible&&(o>=n&&tf(s,r.path)?i=!1:kl(r.path,s.path)&&(a=!0)),o--}if(i){if(a)return function(e){e.visibleWrites=rf(e.allWrites,nf,cl()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1}(e),!0;r.snap?e.visibleWrites=Bh(e.visibleWrites,r.path):Rc(r.children,(function(t){e.visibleWrites=Bh(e.visibleWrites,yl(r.path,t))}));return!0}return!1}function tf(e,t){if(e.snap)return kl(e.path,t);for(var n in e.children)if(e.children.hasOwnProperty(n)&&kl(yl(e.path,n),t))return!0;return!1}function nf(e){return e.visible}function rf(e,t,n){for(var r=Wh.empty(),i=0;i<e.length;++i){var a=e[i];if(t(a)){var o=a.path,s=void 0;if(a.snap)kl(n,o)?r=Vh(r,s=gl(n,o),a.snap):kl(o,n)&&(s=gl(o,n),r=Vh(r,cl(),a.snap.getChild(s)));else{if(!a.children)throw q("WriteRecord should have .snap or .children");if(kl(n,o))r=Hh(r,s=gl(n,o),a.children);else if(kl(o,n))if(ml(s=gl(o,n)))r=Hh(r,cl(),a.children);else{var u=ke(a.children,ll(s));if(u){var c=u.getChild(fl(s));r=Vh(r,cl(),c)}}}}}return r}function af(e,t,n,r,i){if(r||i){var a=Yh(e.visibleWrites,t);if(!i&&Jh(a))return n;if(i||null!=n||zh(a,cl())){return Qh(rf(e.allWrites,(function(e){return(e.visible||i)&&(!r||!~r.indexOf(e.writeId))&&(kl(e.path,t)||kl(t,e.path))}),t),n||eh.EMPTY_NODE)}return null}var o=Kh(e.visibleWrites,t);if(null!=o)return o;var s=Yh(e.visibleWrites,t);return Jh(s)?n:null!=n||zh(s,cl())?Qh(s,n||eh.EMPTY_NODE):null}function of(e,t,n,r){return af(e.writeTree,e.treePath,t,n,r)}function sf(e,t){return function(e,t,n){var r=eh.EMPTY_NODE,i=Kh(e.visibleWrites,t);if(i)return i.isLeafNode()||i.forEachChild(Yl,(function(e,t){r=r.updateImmediateChild(e,t)})),r;if(n){var a=Yh(e.visibleWrites,t);return n.forEachChild(Yl,(function(e,t){var n=Qh(Yh(a,new ul(e)),t);r=r.updateImmediateChild(e,n)})),Gh(a).forEach((function(e){r=r.updateImmediateChild(e.name,e.node)})),r}return Gh(Yh(e.visibleWrites,t)).forEach((function(e){r=r.updateImmediateChild(e.name,e.node)})),r}(e.writeTree,e.treePath,t)}function uf(e,t,n,r){return function(e,t,n,r,i){U(r||i,"Either existingEventSnap or existingServerSnap must exist");var a=yl(t,n);if(zh(e.visibleWrites,a))return null;var o=Yh(e.visibleWrites,a);return Jh(o)?i.getChild(n):Qh(o,i.getChild(n))}(e.writeTree,e.treePath,t,n,r)}function cf(e,t){return function(e,t){return Kh(e.visibleWrites,t)}(e.writeTree,yl(e.treePath,t))}function lf(e,t,n,r,i,a){return function(e,t,n,r,i,a,o){var s,u=Yh(e.visibleWrites,t),c=Kh(u,cl());if(null!=c)s=c;else{if(null==n)return[];s=Qh(u,n)}if((s=s.withIndex(o)).isEmpty()||s.isLeafNode())return[];for(var l=[],h=o.getCompare(),f=a?s.getReverseIteratorFrom(r,o):s.getIteratorFrom(r,o),d=f.getNext();d&&l.length<i;)0!==h(d,r)&&l.push(d),d=f.getNext();return l}(e.writeTree,e.treePath,t,n,r,i,a)}function hf(e,t,n){return function(e,t,n,r){var i=yl(t,n),a=Kh(e.visibleWrites,i);return null!=a?a:r.isCompleteForChild(n)?Qh(Yh(e.visibleWrites,i),r.getNode().getImmediateChild(n)):null}(e.writeTree,e.treePath,t,n)}function ff(e,t){return df(yl(e.treePath,t),e.writeTree)}function df(e,t){return{treePath:e,writeTree:t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var pf=function(){"use strict";function t(){e(u)(this,t),this.changeMap=new Map}return e(c)(t,[{key:"trackChildChange",value:function(e){var t=e.type,n=e.childName;U("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),U(".priority"!==n,"Only non-priority child changes can be tracked.");var r=this.changeMap.get(n);if(r){var i=r.type;if("child_added"===t&&"child_removed"===i)this.changeMap.set(n,ch(n,e.snapshotNode,r.snapshotNode));else if("child_removed"===t&&"child_added"===i)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===i)this.changeMap.set(n,uh(n,r.oldSnap));else if("child_changed"===t&&"child_added"===i)this.changeMap.set(n,sh(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==i)throw q("Illegal combination of changes: "+e+" occurred after "+r);this.changeMap.set(n,ch(n,e.snapshotNode,r.oldSnap))}}else this.changeMap.set(n,e)}},{key:"getChanges",value:function(){return Array.from(this.changeMap.values())}}]),t}(),vf=new(function(){"use strict";function t(){e(u)(this,t)}return e(c)(t,[{key:"getCompleteChild",value:function(e){return null}},{key:"getChildAfterChild",value:function(e,t,n){return null}}]),t}()),yf=function(){"use strict";function t(n,r){var i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;e(u)(this,t),this.writes_=n,this.viewCache_=r,this.optCompleteServerCache_=i}return e(c)(t,[{key:"getCompleteChild",value:function(e){var t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);var n=null!=this.optCompleteServerCache_?new Rh(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return hf(this.writes_,e,n)}},{key:"getChildAfterChild",value:function(e,t,n){var r=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:jh(this.viewCache_),i=lf(this.writes_,r,t,1,n,e);return 0===i.length?null:i[0]}}]),t}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mf(e,t,n,r,i){var a,o,s=new pf;if(n.type===bh.OVERWRITE){var u=n;u.source.fromUser?a=kf(e,t,u.path,u.snap,r,i,s):(U(u.source.fromServer,"Unknown source."),o=u.source.tagged||t.serverCache.isFiltered()&&!ml(u.path),a=_f(e,t,u.path,u.snap,r,i,o,s))}else if(n.type===bh.MERGE){var c=n;c.source.fromUser?a=function(e,t,n,r,i,a,o){var s=t;return r.foreach((function(r,u){var c=yl(n,r);bf(t,ll(c))&&(s=kf(e,s,c,u,i,a,o))})),r.foreach((function(r,u){var c=yl(n,r);bf(t,ll(c))||(s=kf(e,s,c,u,i,a,o))})),s}(e,t,c.path,c.children,r,i,s):(U(c.source.fromServer,"Unknown source."),o=c.source.tagged||t.serverCache.isFiltered(),a=If(e,t,c.path,c.children,r,i,o,s))}else if(n.type===bh.ACK_USER_WRITE){var l=n;a=l.revert?function(e,t,n,r,i,a){var o;if(null!=cf(r,n))return t;var s,u=new yf(r,t,i),c=t.eventCache.getNode();if(ml(n)||".priority"===ll(n)){var l;if(t.serverCache.isFullyInitialized())l=of(r,jh(t));else{var h=t.serverCache.getNode();U(h instanceof eh,"serverChildren would be complete if leaf node"),l=sf(r,h)}s=e.filter.updateFullNode(c,l,a)}else{var f=ll(n),d=hf(r,f,t.serverCache);null==d&&t.serverCache.isCompleteForChild(f)&&(d=c.getImmediateChild(f)),(s=null!=d?e.filter.updateChild(c,f,d,fl(n),u,a):t.eventCache.getNode().hasChild(f)?e.filter.updateChild(c,f,eh.EMPTY_NODE,fl(n),u,a):c).isEmpty()&&t.serverCache.isFullyInitialized()&&(o=of(r,jh(t))).isLeafNode()&&(s=e.filter.updateFullNode(s,o,a))}return o=t.serverCache.isFullyInitialized()||null!=cf(r,cl()),Mh(t,s,o,e.filter.filtersNodes())}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,l.path,r,i,s):function(e,t,n,r,i,a,o){if(null!=cf(i,n))return t;var s=t.serverCache.isFiltered(),u=t.serverCache;if(null!=r.value){if(ml(n)&&u.isFullyInitialized()||u.isCompleteForPath(n))return _f(e,t,n,u.getNode().getChild(n),i,a,s,o);if(ml(n)){var c=new qh(null);return u.getNode().forEachChild(Rl,(function(e,t){c=c.set(new ul(e),t)})),If(e,t,n,c,i,a,s,o)}return t}var l=new qh(null);return r.foreach((function(e,t){var r=yl(n,e);u.isCompleteForPath(r)&&(l=l.set(e,u.getNode().getChild(r)))})),If(e,t,n,l,i,a,s,o)}(e,t,l.path,l.affectedTree,r,i,s)}else{if(n.type!==bh.LISTEN_COMPLETE)throw q("Unknown operation type: "+n.type);a=function(e,t,n,r,i){var a=t.serverCache,o=Lh(t,a.getNode(),a.isFullyInitialized()||ml(n),a.isFiltered());return gf(e,o,n,r,vf,i)}(e,t,n.path,r,s)}var h=s.getChanges();return function(e,t,n){var r=t.eventCache;if(r.isFullyInitialized()){var i=r.getNode().isLeafNode()||r.getNode().isEmpty(),a=Fh(e);(n.length>0||!e.eventCache.isFullyInitialized()||i&&!r.getNode().equals(a)||!r.getNode().getPriority().equals(a.getPriority()))&&n.push(oh(Fh(t)))}}(t,a,h),{viewCache:a,changes:h}}function gf(e,t,n,r,i,a){var o,s,u=t.eventCache;if(null!=cf(r,n))return t;if(ml(n))if(U(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){var c=jh(t),l=sf(r,c instanceof eh?c:eh.EMPTY_NODE);o=e.filter.updateFullNode(t.eventCache.getNode(),l,a)}else{var h=of(r,jh(t));o=e.filter.updateFullNode(t.eventCache.getNode(),h,a)}else{var f=ll(n);if(".priority"===f){U(1===hl(n),"Can't have a priority with additional path components");var d=u.getNode(),p=uf(r,n,d,s=t.serverCache.getNode());o=null!=p?e.filter.updatePriority(d,p):u.getNode()}else{var v,y=fl(n);if(u.isCompleteForChild(f)){s=t.serverCache.getNode();var m=uf(r,n,u.getNode(),s);v=null!=m?u.getNode().getImmediateChild(f).updateChild(y,m):u.getNode().getImmediateChild(f)}else v=hf(r,f,t.serverCache);o=null!=v?e.filter.updateChild(u.getNode(),f,v,y,i,a):u.getNode()}}return Mh(t,o,u.isFullyInitialized()||ml(n),e.filter.filtersNodes())}function _f(e,t,n,r,i,a,o,s){var u,c=t.serverCache,l=o?e.filter:e.filter.getIndexedFilter();if(ml(n))u=l.updateFullNode(c.getNode(),r,null);else if(l.filtersNodes()&&!c.isFiltered()){var h=c.getNode().updateChild(n,r);u=l.updateFullNode(c.getNode(),h,null)}else{var f=ll(n);if(!c.isCompleteForPath(n)&&hl(n)>1)return t;var d=fl(n),p=c.getNode().getImmediateChild(f).updateChild(d,r);u=".priority"===f?l.updatePriority(c.getNode(),p):l.updateChild(c.getNode(),f,p,d,vf,null)}var v=Lh(t,u,c.isFullyInitialized()||ml(n),l.filtersNodes());return gf(e,v,n,i,new yf(i,v,a),s)}function kf(e,t,n,r,i,a,o){var s,u,c=t.eventCache,l=new yf(i,t,a);if(ml(n))u=e.filter.updateFullNode(t.eventCache.getNode(),r,o),s=Mh(t,u,!0,e.filter.filtersNodes());else{var h=ll(n);if(".priority"===h)u=e.filter.updatePriority(t.eventCache.getNode(),r),s=Mh(t,u,c.isFullyInitialized(),c.isFiltered());else{var f,d=fl(n),p=c.getNode().getImmediateChild(h);if(ml(d))f=r;else{var v=l.getCompleteChild(h);f=null!=v?".priority"===dl(d)&&v.getChild(vl(d)).isEmpty()?v:v.updateChild(d,r):eh.EMPTY_NODE}if(p.equals(f))s=t;else s=Mh(t,e.filter.updateChild(c.getNode(),h,f,d,l,o),c.isFullyInitialized(),e.filter.filtersNodes())}}return s}function bf(e,t){return e.eventCache.isCompleteForChild(t)}function wf(e,t,n){return n.foreach((function(e,n){t=t.updateChild(e,n)})),t}function If(e,t,n,r,i,a,o,s){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;var u,c=t;u=ml(n)?r:new qh(null).setTree(n,r);var l=t.serverCache.getNode();return u.children.inorderTraversal((function(n,r){if(l.hasChild(n)){var u=wf(0,t.serverCache.getNode().getImmediateChild(n),r);c=_f(e,c,new ul(n),u,i,a,o,s)}})),u.children.inorderTraversal((function(n,r){var u=!t.serverCache.isCompleteForChild(n)&&null===r.value;if(!l.hasChild(n)&&!u){var h=wf(0,t.serverCache.getNode().getImmediateChild(n),r);c=_f(e,c,new ul(n),h,i,a,o,s)}})),c}var xf,Cf=function(){"use strict";function t(n,r){e(u)(this,t),this.query_=n,this.eventRegistrations_=[];var i,a=this.query_._queryParams,o=new lh(a.getIndex()),s=(i=a).loadsAllData()?new lh(i.getIndex()):i.hasLimit()?new fh(i):new hh(i);this.processor_=
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){return{filter:e}}(s);var c=r.serverCache,l=r.eventCache,h=o.updateFullNode(eh.EMPTY_NODE,c.getNode(),null),f=s.updateFullNode(eh.EMPTY_NODE,l.getNode(),null),d=new Rh(h,c.isFullyInitialized(),o.filtersNodes()),p=new Rh(f,l.isFullyInitialized(),s.filtersNodes());this.viewCache_=Dh(p,d),this.eventGenerator_=new Oh(this.query_)}return e(c)(t,[{key:"query",get:function(){return this.query_}}]),t}();function Tf(e,t){var n=jh(e.viewCache_);return n&&(e.query._queryParams.loadsAllData()||!ml(t)&&!n.getImmediateChild(ll(t)).isEmpty())?n.getChild(t):null}function Ef(e){return 0===e.eventRegistrations_.length}function Sf(e,t,n){var r=[];if(n){U(null==t,"A cancel should cancel all event registrations.");var i=e.query._path;e.eventRegistrations_.forEach((function(e){var t=e.createCancelEvent(n,i);t&&r.push(t)}))}if(t){for(var a=[],o=0;o<e.eventRegistrations_.length;++o){var s=e.eventRegistrations_[o];if(s.matches(t)){if(t.hasAnyCallback()){a=a.concat(e.eventRegistrations_.slice(o+1));break}}else a.push(s)}e.eventRegistrations_=a}else e.eventRegistrations_=[];return r}function Pf(e,t,n,r){t.type===bh.MERGE&&null!==t.source.queryId&&(U(jh(e.viewCache_),"We should always have a full cache before handling merges"),U(Fh(e.viewCache_),"Missing event cache, even though we have a server cache"));var i,a,o=e.viewCache_,s=mf(e.processor_,o,t,n,r);return i=e.processor_,a=s.viewCache,U(a.eventCache.getNode().isIndexed(i.filter.getIndex()),"Event snap not indexed"),U(a.serverCache.getNode().isIndexed(i.filter.getIndex()),"Server snap not indexed"),U(s.viewCache.serverCache.isFullyInitialized()||!o.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),e.viewCache_=s.viewCache,Nf(e,s.changes,s.viewCache.eventCache.getNode(),null)}function Nf(e,t,n,r){var i=r?[r]:e.eventRegistrations_;return function(e,t,n,r){var i=[],a=[];return t.forEach((function(t){var n;"child_changed"===t.type&&e.index_.indexedValueChanged(t.oldSnap,t.snapshotNode)&&a.push((n=t.childName,{type:"child_moved",snapshotNode:t.snapshotNode,childName:n}))})),Ah(e,i,"child_removed",t,r,n),Ah(e,i,"child_added",t,r,n),Ah(e,i,"child_moved",a,r,n),Ah(e,i,"child_changed",t,r,n),Ah(e,i,"value",t,r,n),i}(e.eventGenerator_,t,n,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Rf,Of=function t(){"use strict";e(u)(this,t),this.views=new Map};function Af(e){return 0===e.views.size}function Df(e,t,n,r){var i=t.source.queryId;if(null!==i){var a=e.views.get(i);return U(null!=a,"SyncTree gave us an op for an invalid query."),Pf(a,t,n,r)}var o=[],s=!0,u=!1,c=void 0;try{for(var l,h=e.views.values()[Symbol.iterator]();!(s=(l=h.next()).done);s=!0){var f=l.value;o=o.concat(Pf(f,t,n,r))}}catch(e){u=!0,c=e}finally{try{s||null==h.return||h.return()}finally{if(u)throw c}}return o}function Mf(e,t,n,r,i){var a=t._queryIdentifier,o=e.views.get(a);if(!o){var s=of(n,i?r:null),u=!1;s?u=!0:r instanceof eh?(s=sf(n,r),u=!1):(s=eh.EMPTY_NODE,u=!1);var c=Dh(new Rh(s,u,!1),new Rh(r,i,!1));return new Cf(t,c)}return o}function Lf(e,t,n,r,i,a){var o=Mf(e,t,r,i,a);return e.views.has(t._queryIdentifier)||e.views.set(t._queryIdentifier,o),function(e,t){e.eventRegistrations_.push(t)}(o,n),function(e,t){var n=e.viewCache_.eventCache,r=[];return n.getNode().isLeafNode()||n.getNode().forEachChild(Yl,(function(e,t){r.push(sh(e,t))})),n.isFullyInitialized()&&r.push(oh(n.getNode())),Nf(e,r,n.getNode(),t)}(o,n)}function Ff(t,n,r,i){var a=n._queryIdentifier,o=[],s=[],u=Vf(t),c=!0,l=!1,f=void 0;if("default"===a)try{for(var d,p=t.views.entries()[Symbol.iterator]();!(c=(d=p.next()).done);c=!0){var v=e(h)(d.value,2),y=v[0],m=v[1];s=s.concat(Sf(m,r,i)),Ef(m)&&(t.views.delete(y),m.query._queryParams.loadsAllData()||o.push(m.query))}}catch(e){l=!0,f=e}finally{try{c||null==p.return||p.return()}finally{if(l)throw f}}else{var g=t.views.get(a);g&&(s=s.concat(Sf(g,r,i)),Ef(g)&&(t.views.delete(a),g.query._queryParams.loadsAllData()||o.push(g.query)))}return u&&!Vf(t)&&o.push(new(U(xf,"Reference.ts has not been loaded"),xf)(n._repo,n._path)),{removed:o,events:s}}function jf(e){var t=[],n=!0,r=!1,i=void 0;try{for(var a,o=e.views.values()[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){var s=a.value;s.query._queryParams.loadsAllData()||t.push(s)}}catch(e){r=!0,i=e}finally{try{n||null==o.return||o.return()}finally{if(r)throw i}}return t}function Uf(e,t){var n=null,r=!0,i=!1,a=void 0;try{for(var o,s=e.views.values()[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var u=o.value;n=n||Tf(u,t)}}catch(e){i=!0,a=e}finally{try{r||null==s.return||s.return()}finally{if(i)throw a}}return n}function qf(e,t){if(t._queryParams.loadsAllData())return Hf(e);var n=t._queryIdentifier;return e.views.get(n)}function Wf(e,t){return null!=qf(e,t)}function Vf(e){return null!=Hf(e)}function Hf(e){var t=!0,n=!1,r=void 0;try{for(var i,a=e.views.values()[Symbol.iterator]();!(t=(i=a.next()).done);t=!0){var o=i.value;if(o.query._queryParams.loadsAllData())return o}}catch(e){n=!0,r=e}finally{try{t||null==a.return||a.return()}finally{if(n)throw r}}return null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Bf=1,zf=function t(n){"use strict";e(u)(this,t),this.listenProvider_=n,this.syncPointTree_=new qh(null),this.pendingWriteTree_={visibleWrites:Wh.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map};function Kf(e,t,n,r,i){return function(e,t,n,r,i){U(r>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===i&&(i=!0),e.allWrites.push({path:t,snap:n,writeId:r,visible:i}),i&&(e.visibleWrites=Vh(e.visibleWrites,t,n)),e.lastWriteId=r}(e.pendingWriteTree_,t,n,r,i),i?ed(e,new Ph({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function Gf(e,t){var n=arguments.length>2&&void 0!==arguments[2]&&arguments[2],r=Zh(e.pendingWriteTree_,t),i=ef(e.pendingWriteTree_,t);if(i){var a=new qh(null);return null!=r.snap?a=a.set(cl(),!0):Rc(r.children,(function(e){a=a.set(new ul(e),!0)})),ed(e,new Eh(r.path,a,n))}return[]}function Yf(e,t,n){return ed(e,new Ph({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Jf(e,t,n,r){var i=arguments.length>4&&void 0!==arguments[4]&&arguments[4],a=t._path,o=e.syncPointTree_.get(a),s=[];if(o&&("default"===t._queryIdentifier||Wf(o,t))){var u=Ff(o,t,n,r);Af(o)&&(e.syncPointTree_=e.syncPointTree_.remove(a));var c=u.removed;if(s=u.events,!i){var l=-1!==c.findIndex((function(e){return e._queryParams.loadsAllData()})),h=e.syncPointTree_.findOnPath(a,(function(e,t){return Vf(t)}));if(l&&!h){var f=e.syncPointTree_.subtree(a);if(!f.isEmpty())for(var d=cd(f),p=0;p<d.length;++p){var v=d[p],y=v.query,m=rd(e,v);e.listenProvider_.startListening(ld(y),id(e,y),m.hashFn,m.onComplete)}}if(!h&&c.length>0&&!r)if(l){var g=null;e.listenProvider_.stopListening(ld(t),g)}else c.forEach((function(t){var n=e.queryToTagMap.get(ad(t));e.listenProvider_.stopListening(ld(t),n)}))}hd(e,c)}return s}function Qf(e,t,n,r){var i=od(e,r);if(null!=i){var a=sd(i),o=a.path,s=a.queryId,u=gl(o,t);return ud(e,o,new Ph(Ch(s),u,n))}return[]}function $f(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]&&arguments[3],i=t._path,a=null,o=!1;e.syncPointTree_.foreachOnPath(i,(function(e,t){var n=gl(e,i);a=a||Uf(t,n),o=o||Vf(t)}));var s,u=e.syncPointTree_.get(i);if(u?(o=o||Vf(u),a=a||Uf(u,cl())):(u=new Of,e.syncPointTree_=e.syncPointTree_.set(i,u)),null!=a)s=!0;else{s=!1,a=eh.EMPTY_NODE;var c=e.syncPointTree_.subtree(i);c.foreachChild((function(e,t){var n=Uf(t,cl());n&&(a=a.updateImmediateChild(e,n))}))}var l=Wf(u,t);if(!l&&!t._queryParams.loadsAllData()){var h=ad(t);U(!e.queryToTagMap.has(h),"View does not exist, but we have a tag");var f=fd();e.queryToTagMap.set(h,f),e.tagToQueryMap.set(f,h)}var d=Xh(e.pendingWriteTree_,i),p=Lf(u,t,n,d,a,s);if(!l&&!o&&!r){var v=qf(u,t);p=p.concat(dd(e,t,v))}return p}function Xf(e,t,n){var r=e.pendingWriteTree_,i=e.syncPointTree_.findOnPath(t,(function(e,n){var r=Uf(n,gl(e,t));if(r)return r}));return af(r,t,i,n,!0)}function Zf(e,t){var n=t._path,r=null;e.syncPointTree_.foreachOnPath(n,(function(e,t){var i=gl(e,n);r=r||Uf(t,i)}));var i=e.syncPointTree_.get(n);i?r=r||Uf(i,cl()):(i=new Of,e.syncPointTree_=e.syncPointTree_.set(n,i));var a=null!=r,o=a?new Rh(r,!0,!1):null;return function(e){return Fh(e.viewCache_)}(Mf(i,t,Xh(e.pendingWriteTree_,t._path),a?o.getNode():eh.EMPTY_NODE,a))}function ed(e,t){return td(t,e.syncPointTree_,null,Xh(e.pendingWriteTree_,cl()))}function td(e,t,n,r){if(ml(e.path))return nd(e,t,n,r);var i=t.get(cl());null==n&&null!=i&&(n=Uf(i,cl()));var a=[],o=ll(e.path),s=e.operationForChild(o),u=t.children.get(o);if(u&&s){var c=n?n.getImmediateChild(o):null,l=ff(r,o);a=a.concat(td(s,u,c,l))}return i&&(a=a.concat(Df(i,e,r,n))),a}function nd(e,t,n,r){var i=t.get(cl());null==n&&null!=i&&(n=Uf(i,cl()));var a=[];return t.children.inorderTraversal((function(t,i){var o=n?n.getImmediateChild(t):null,s=ff(r,t),u=e.operationForChild(t);u&&(a=a.concat(nd(u,i,o,s)))})),i&&(a=a.concat(Df(i,e,r,n))),a}function rd(e,t){var n=t.query,r=id(e,n);return{hashFn:function(){var e=function(e){return e.viewCache_.serverCache.getNode()}(t)||eh.EMPTY_NODE;return e.hash()},onComplete:function(t){if("ok"===t)return r?function(e,t,n){var r=od(e,n);if(r){var i=sd(r),a=i.path,o=i.queryId,s=gl(a,t);return ud(e,a,new Sh(Ch(o),s))}return[]}(e,n._path,r):function(e,t){return ed(e,new Sh({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t))}(e,n._path);var i=function(e,t){var n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");var r=new Error(e+" at "+t._path.toString()+": "+n);return r.code=e.toUpperCase(),r}(t,n);return Jf(e,n,null,i)}}}function id(e,t){var n=ad(t);return e.queryToTagMap.get(n)}function ad(e){return e._path.toString()+"$"+e._queryIdentifier}function od(e,t){return e.tagToQueryMap.get(t)}function sd(e){var t=e.indexOf("$");return U(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new ul(e.substr(0,t))}}function ud(e,t,n){var r=e.syncPointTree_.get(t);return U(r,"Missing sync point for query tag that we're tracking"),Df(r,n,Xh(e.pendingWriteTree_,t),null)}function cd(e){return e.fold((function(e,t,n){if(t&&Vf(t))return[Hf(t)];var r=[];return t&&(r=jf(t)),Rc(n,(function(e,t){r=r.concat(t)})),r}))}function ld(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(U(Rf,"Reference.ts has not been loaded"),Rf)(e._repo,e._path):e}function hd(e,t){for(var n=0;n<t.length;++n){var r=t[n];if(!r._queryParams.loadsAllData()){var i=ad(r),a=e.queryToTagMap.get(i);e.queryToTagMap.delete(i),e.tagToQueryMap.delete(a)}}}function fd(){return Bf++}function dd(e,t,n){var r=t._path,i=id(e,t),a=rd(e,n),o=e.listenProvider_.startListening(ld(t),i,a.hashFn,a.onComplete),s=e.syncPointTree_.subtree(r);if(i)U(!Vf(s.value),"If we're adding a query, it shouldn't be shadowed");else for(var u=s.fold((function(e,t,n){if(!ml(e)&&t&&Vf(t))return[Hf(t).query];var r=[];return t&&(r=r.concat(jf(t).map((function(e){return e.query})))),Rc(n,(function(e,t){r=r.concat(t)})),r})),c=0;c<u.length;++c){var l=u[c];e.listenProvider_.stopListening(ld(l),id(e,l))}return o}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var pd=function(){"use strict";function t(n){e(u)(this,t),this.node_=n}return e(c)(t,[{key:"getImmediateChild",value:function(e){return new t(this.node_.getImmediateChild(e))}},{key:"node",value:function(){return this.node_}}]),t}(),vd=function(){"use strict";function t(n,r){e(u)(this,t),this.syncTree_=n,this.path_=r}return e(c)(t,[{key:"getImmediateChild",value:function(e){var n=yl(this.path_,e);return new t(this.syncTree_,n)}},{key:"node",value:function(){return Xf(this.syncTree_,this.path_)}}]),t}(),yd=function(e,t,n){return e&&"object"==typeof e?(U(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?md(e[".sv"],t,n):"object"==typeof e[".sv"]?gd(e[".sv"],t):void U(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},md=function(e,t,n){if("timestamp"===e)return n.timestamp;U(!1,"Unexpected server value: "+e)},gd=function(e,t,n){e.hasOwnProperty("increment")||U(!1,"Unexpected server value: "+JSON.stringify(e,null,2));var r=e.increment;"number"!=typeof r&&U(!1,"Unexpected increment value: "+r);var i=t.node();if(U(null!=i,"Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return r;var a=i.getValue();return"number"!=typeof a?r:a+r},_d=function(e,t,n,r){return bd(t,new vd(n,e),r)},kd=function(e,t,n){return bd(e,new pd(t),n)};function bd(e,t,n){var r,i=e.getPriority().val(),a=yd(i,t.getImmediateChild(".priority"),n);if(e.isLeafNode()){var o=e,s=yd(o.getValue(),t,n);return s!==o.getValue()||a!==o.getPriority().val()?new Bl(s,nh(a)):e}var u=e;return r=u,a!==u.getPriority().val()&&(r=r.updatePriority(new Bl(a))),u.forEachChild(Yl,(function(e,i){var a=bd(i,t.getImmediateChild(e),n);a!==i&&(r=r.updateImmediateChild(e,a))})),r}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var wd=function t(){"use strict";var n=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"",r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{children:{},childCount:0};e(u)(this,t),this.name=n,this.parent=r,this.node=i};function Id(e,t){for(var n=t instanceof ul?t:new ul(t),r=e,i=ll(n);null!==i;){var a=ke(r.node.children,i)||{children:{},childCount:0};r=new wd(i,r,a),i=ll(n=fl(n))}return r}function xd(e){return e.node.value}function Cd(e,t){e.node.value=t,Nd(e)}function Td(e){return e.node.childCount>0}function Ed(e,t){Rc(e.node.children,(function(n,r){t(new wd(n,e,r))}))}function Sd(e,t,n,r){n&&!r&&t(e),Ed(e,(function(e){Sd(e,t,!0,r)})),n&&r&&t(e)}function Pd(e){return new ul(null===e.parent?e.name:Pd(e.parent)+"/"+e.name)}function Nd(e){null!==e.parent&&function(e,t,n){var r=function(e){return void 0===xd(e)&&!Td(e)}(n),i=_e(e.node.children,t);r&&i?(delete e.node.children[t],e.node.childCount--,Nd(e)):r||i||(e.node.children[t]=n.node,e.node.childCount++,Nd(e))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}var Rd=/[\[\].#$\/\u0000-\u001F\u007F]/,Od=/[\[\].#$\u0000-\u001F\u007F]/,Ad=10485760,Dd=function(e){return"string"==typeof e&&0!==e.length&&!Rd.test(e)},Md=function(e){return"string"==typeof e&&0!==e.length&&!Od.test(e)},Ld=function(e,t,n,r){r&&void 0===t||Fd(Re(e,"value"),t,n)},Fd=function(e,t,n){var r=n instanceof ul?new bl(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Il(r));if("function"==typeof t)throw new Error(e+"contains a function "+Il(r)+" with contents = "+t.toString());if(Ic(t))throw new Error(e+"contains "+t.toString()+" "+Il(r));if("string"==typeof t&&t.length>3495253.3333333335&&Ae(t)>Ad)throw new Error(e+"contains a string greater than "+"10485760 utf8 bytes "+Il(r)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){var i=!1,a=!1;if(Rc(t,(function(t,n){if(".value"===t)i=!0;else if(".priority"!==t&&".sv"!==t&&(a=!0,!Dd(t)))throw new Error(e+" contains an invalid key ("+t+") "+Il(r)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var o,s;s=t,(o=r).parts_.length>0&&(o.byteLength_+=1),o.parts_.push(s),o.byteLength_+=Ae(s),wl(o),Fd(e,n,r),function(e){var t=e.parts_.pop();e.byteLength_-=Ae(t),e.parts_.length>0&&(e.byteLength_-=1)}(r)})),i&&a)throw new Error(e+' contains ".value" child '+Il(r)+" in addition to actual children.")}},jd=function(e,t,n,r){if(!(r&&void 0===n||Md(n)))throw new Error(Re(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},Ud=function(e,t){if(".info"===ll(t))throw new Error(e+" failed = Can't modify data under /.info/")},qd=function(e,t){var n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!Dd(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),Md(e)}(n))throw new Error(Re(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')},Wd=function t(){"use strict";e(u)(this,t),this.eventLists_=[],this.recursionDepth_=0};function Vd(e,t){for(var n=null,r=0;r<t.length;r++){var i=t[r],a=i.getPath();null===n||_l(a,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:a}),n.events.push(i)}n&&e.eventLists_.push(n)}function Hd(e,t,n){Vd(e,n),Bd(e,(function(e){return kl(e,t)||kl(t,e)}))}function Bd(e,t){e.recursionDepth_++;for(var n=!0,r=0;r<e.eventLists_.length;r++){var i=e.eventLists_[r];if(i)t(i.path)?(zd(e.eventLists_[r]),e.eventLists_[r]=null):n=!1}n&&(e.eventLists_=[]),e.recursionDepth_--}function zd(e){for(var t=0;t<e.events.length;t++){var n=e.events[t];if(null!==n){e.events[t]=null;var r=n.getEventRunner();vc&&gc("event: "+n.toString()),Mc(r)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Kd="repo_interrupt",Gd=function(){"use strict";function t(n,r,i,a){e(u)(this,t),this.repoInfo_=n,this.forceRestClient_=r,this.authTokenProvider_=i,this.appCheckProvider_=a,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Wd,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=gh(),this.transactionQueueTree_=new wd,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}return e(c)(t,[{key:"toString",value:function(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}]),t}();function Yd(e,t,n){if(e.stats_=Jc(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new yh(e.repoInfo_,(function(t,n,r,i){$d(e,t,n,r,i)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((function(){return Xd(e,!0)}),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{ye(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new Tl(e.repoInfo_,t,(function(t,n,r,i){$d(e,t,n,r,i)}),(function(t){Xd(e,t)}),(function(t){!function(e,t){Rc(t,(function(t,n){Zd(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}var r,i,a;e.authTokenProvider_.addTokenChangeListener((function(t){e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((function(t){e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=(r=e.repoInfo_,i=function(){return new xh(e.stats_,e.server_)},a=r.toString(),Yc[a]||(Yc[a]=i()),Yc[a]),e.infoData_=new mh,e.infoSyncTree_=new zf({startListening:function(t,n,r,i){var a=[],o=e.infoData_.getNode(t._path);return o.isEmpty()||(a=Yf(e.infoSyncTree_,t._path,o),setTimeout((function(){i("ok")}),0)),a},stopListening:function(){}}),Zd(e,"connected",!1),e.serverSyncTree_=new zf({startListening:function(t,n,r,i){return e.server_.listen(t,r,n,(function(n,r){var a=i(n,r);Hd(e.eventQueue_,t._path,a)})),[]},stopListening:function(t,n){e.server_.unlisten(t,n)}})}function Jd(e){var t=e.infoData_.getNode(new ul(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function Qd(e){return(t=(t={timestamp:Jd(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function $d(e,t,n,r,i){e.dataUpdateCount++;var a=new ul(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;var o=[];if(i)if(r){var s=we(n,(function(e){return nh(e)}));o=function(e,t,n,r){var i=od(e,r);if(i){var a=sd(i),o=a.path,s=a.queryId,u=gl(o,t),c=qh.fromObject(n);return ud(e,o,new Nh(Ch(s),u,c))}return[]}(e.serverSyncTree_,a,s,i)}else{var u=nh(n);o=Qf(e.serverSyncTree_,a,u,i)}else if(r){var c=we(n,(function(e){return nh(e)}));o=function(e,t,n){var r=qh.fromObject(n);return ed(e,new Nh({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,r))}(e.serverSyncTree_,a,c)}else{var l=nh(n);o=Yf(e.serverSyncTree_,a,l)}var h=a;o.length>0&&(h=up(e,a)),Hd(e.eventQueue_,h,o)}function Xd(e,t){Zd(e,"connected",t),!1===t&&function(e){rp(e,"onDisconnectEvents");var t=Qd(e),n=gh();kh(e.onDisconnect_,cl(),(function(r,i){var a=_d(r,i,e.serverSyncTree_,t);_h(n,r,a)}));var r=[];kh(n,cl(),(function(t,n){r=r.concat(Yf(e.serverSyncTree_,t,n));var i=dp(e,t);up(e,i)})),e.onDisconnect_=gh(),Hd(e.eventQueue_,cl(),r)}(e)}function Zd(e,t,n){var r=new ul("/.info/"+t),i=nh(n);e.infoData_.updateSnapshot(r,i);var a=Yf(e.infoSyncTree_,r,i);Hd(e.eventQueue_,r,a)}function ep(e){return e.nextWriteId_++}function tp(e,t,n,r,i){rp(e,"set",{path:t.toString(),value:n,priority:r});var a=Qd(e),o=nh(n,r),s=Xf(e.serverSyncTree_,t),u=kd(o,s,a),c=ep(e),l=Kf(e.serverSyncTree_,t,u,c,!0);Vd(e.eventQueue_,l),e.server_.put(t.toString(),o.val(!0),(function(n,r){var a="ok"===n;a||wc("set at "+t+" failed: "+n);var o=Gf(e.serverSyncTree_,c,!a);Hd(e.eventQueue_,t,o),ip(e,i,n,r)}));var h=dp(e,t);up(e,h),Hd(e.eventQueue_,h,[])}function np(e){e.persistentConnection_&&e.persistentConnection_.interrupt(Kd)}function rp(t){for(var n=arguments.length,r=new Array(n>1?n-1:0),i=1;i<n;i++)r[i-1]=arguments[i];var a="";t.persistentConnection_&&(a=t.persistentConnection_.id+":"),gc.apply(void 0,[a].concat(e(f)(r)))}function ip(e,t,n,r){t&&Mc((function(){if("ok"===n)t(null);else{var e=(n||"error").toUpperCase(),i=e;r&&(i+=": "+r);var a=new Error(i);a.code=e,t(a)}}))}function ap(e,t,n){return Xf(e.serverSyncTree_,t,n)||eh.EMPTY_NODE}function op(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:e.transactionQueueTree_;if(t||fp(e,t),xd(t)){var n=lp(e,t);U(n.length>0,"Sending zero length transaction queue");var r=n.every((function(e){return 0===e.status}));r&&sp(e,Pd(t),n)}else Td(t)&&Ed(t,(function(t){op(e,t)}))}function sp(e,t,n){for(var r=n.map((function(e){return e.currentWriteId})),i=ap(e,t,r),a=i,o=i.hash(),s=0;s<n.length;s++){var u=n[s];U(0===u.status,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;var c=gl(t,u.path);a=a.updateChild(c,u.currentOutputSnapshotRaw)}var l=a.val(!0),h=t;e.server_.put(h.toString(),l,(function(r){rp(e,"transaction put response",{path:h.toString(),status:r});var i=[];if("ok"===r){for(var a=function(t){n[t].status=2,i=i.concat(Gf(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&o.push((function(){return n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved)})),n[t].unwatcher()},o=[],s=0;s<n.length;s++)a(s);fp(e,Id(e.transactionQueueTree_,t)),op(e,e.transactionQueueTree_),Hd(e.eventQueue_,t,i);for(var u=0;u<o.length;u++)Mc(o[u])}else{if("datastale"===r)for(var c=0;c<n.length;c++)3===n[c].status?n[c].status=4:n[c].status=0;else{wc("transaction at "+h.toString()+" failed: "+r);for(var l=0;l<n.length;l++)n[l].status=4,n[l].abortReason=r}up(e,t)}}),o)}function up(e,t){var n=cp(e,t),r=Pd(n);return function(e,t,n){var r=function(r){var s,u=t[r],c=gl(n,u.path),l=!1,h=void 0;if(U(null!==c,"rerunTransactionsUnderNode_: relativePath should not be null."),4===u.status)l=!0,h=u.abortReason,a=a.concat(Gf(e.serverSyncTree_,u.currentWriteId,!0));else if(0===u.status)if(u.retryCount>=25)l=!0,h="maxretry",a=a.concat(Gf(e.serverSyncTree_,u.currentWriteId,!0));else{var f=ap(e,u.path,o);u.currentInputSnapshot=f;var d=t[r].update(f.val());if(void 0!==d){Fd("transaction failed: Data returned ",d,u.path);var p=nh(d);"object"==typeof d&&null!=d&&_e(d,".priority")||(p=p.updatePriority(f.getPriority()));var v=u.currentWriteId,y=Qd(e),m=kd(p,f,y);u.currentOutputSnapshotRaw=p,u.currentOutputSnapshotResolved=m,u.currentWriteId=ep(e),o.splice(o.indexOf(v),1),a=(a=a.concat(Kf(e.serverSyncTree_,u.path,m,u.currentWriteId,u.applyLocally))).concat(Gf(e.serverSyncTree_,v,!0))}else l=!0,h="nodata",a=a.concat(Gf(e.serverSyncTree_,u.currentWriteId,!0))}Hd(e.eventQueue_,n,a),a=[],l&&(t[r].status=2,s=t[r].unwatcher,setTimeout(s,Math.floor(0)),t[r].onComplete&&("nodata"===h?i.push((function(){return t[r].onComplete(null,!1,t[r].currentInputSnapshot)})):i.push((function(){return t[r].onComplete(new Error(h),!1,null)}))))};if(0===t.length)return;for(var i=[],a=[],o=t.filter((function(e){return 0===e.status})).map((function(e){return e.currentWriteId})),s=0;s<t.length;s++)r(s);fp(e,e.transactionQueueTree_);for(var u=0;u<i.length;u++)Mc(i[u]);op(e,e.transactionQueueTree_)}(e,lp(e,n),r),r}function cp(e,t){var n,r=e.transactionQueueTree_;for(n=ll(t);null!==n&&void 0===xd(r);)r=Id(r,n),n=ll(t=fl(t));return r}function lp(e,t){var n=[];return hp(e,t,n),n.sort((function(e,t){return e.order-t.order})),n}function hp(e,t,n){var r=xd(t);if(r)for(var i=0;i<r.length;i++)n.push(r[i]);Ed(t,(function(t){hp(e,t,n)}))}function fp(e,t){var n=xd(t);if(n){for(var r=0,i=0;i<n.length;i++)2!==n[i].status&&(n[r]=n[i],r++);n.length=r,Cd(t,n.length>0?n:void 0)}Ed(t,(function(t){fp(e,t)}))}function dp(e,t){var n=Pd(cp(e,t)),r=Id(e.transactionQueueTree_,t);return function(e,t,n){for(var r=n?e:e.parent;null!==r;){if(t(r))return!0;r=r.parent}}(r,(function(t){pp(e,t)})),pp(e,r),Sd(r,(function(t){pp(e,t)})),n}function pp(e,t){var n=xd(t);if(n){for(var r=[],i=[],a=-1,o=0;o<n.length;o++)3===n[o].status||(1===n[o].status?(U(a===o-1,"All SENT items should be at beginning of queue."),a=o,n[o].status=3,n[o].abortReason="set"):(U(0===n[o].status,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(Gf(e.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&r.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));-1===a?Cd(t,void 0):n.length=a+1,Hd(e.eventQueue_,Pd(t),i);for(var s=0;s<r.length;s++)Mc(r[s])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var vp,yp,mp=function(e,t){var n=gp(e),r=n.namespace;"firebase.com"===n.domain&&bc(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),r&&"undefined"!==r||"localhost"===n.domain||bc("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||"undefined"!=typeof window&&window.location&&window.location.protocol&&-1!==window.location.protocol.indexOf("https:")&&wc("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().");var i="ws"===n.scheme||"wss"===n.scheme;return{repoInfo:new Bc(n.host,n.secure,r,i,t,"",r!==n.subdomain),path:new ul(n.pathString)}},gp=function(e){var t="",n="",r="",i="",a="",o=!0,s="https",u=443;if("string"==typeof e){var c=e.indexOf("//");c>=0&&(s=e.substring(0,c-1),e=e.substring(c+2));var l=e.indexOf("/");-1===l&&(l=e.length);var h=e.indexOf("?");-1===h&&(h=e.length),t=e.substring(0,Math.min(l,h)),l<h&&(i=function(e){for(var t="",n=e.split("/"),r=0;r<n.length;r++)if(n[r].length>0){var i=n[r];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch(e){}t+="/"+i}return t}(e.substring(l,h)));var f=function(e){var t={};"?"===e.charAt(0)&&(e=e.substring(1));var n=!0,r=!1,i=void 0;try{for(var a,o=e.split("&")[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){var s=a.value;if(0!==s.length){var u=s.split("=");2===u.length?t[decodeURIComponent(u[0])]=decodeURIComponent(u[1]):wc("Invalid query segment '".concat(s,"' in query '").concat(e,"'"))}}}catch(e){r=!0,i=e}finally{try{n||null==o.return||o.return()}finally{if(r)throw i}}return t}(e.substring(Math.min(e.length,h)));(c=t.indexOf(":"))>=0?(o="https"===s||"wss"===s,u=parseInt(t.substring(c+1),10)):c=t.length;var d=t.slice(0,c);if("localhost"===d.toLowerCase())n="localhost";else if(d.split(".").length<=2)n=d;else{var p=t.indexOf(".");r=t.substring(0,p).toLowerCase(),n=t.substring(p+1),a=r}"ns"in f&&(a=f.ns)}return{host:t,port:u,domain:n,subdomain:r,secure:o,scheme:s,pathString:i,namespace:a}},_p="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",kp=(vp=0,yp=[],function(){"use strict";function t(n,r,i,a){e(u)(this,t),this.eventType=n,this.eventRegistration=r,this.snapshot=i,this.prevName=a}return e(c)(t,[{key:"getPath",value:function(){var e=this.snapshot.ref;return"value"===this.eventType?e._path:e.parent._path}},{key:"getEventType",value:function(){return this.eventType}},{key:"getEventRunner",value:function(){return this.eventRegistration.getEventRunner(this)}},{key:"toString",value:function(){return this.getPath().toString()+":"+this.eventType+":"+ye(this.snapshot.exportVal())}}]),t}()),bp=function(){"use strict";function t(n,r,i){e(u)(this,t),this.eventRegistration=n,this.error=r,this.path=i}return e(c)(t,[{key:"getPath",value:function(){return this.path}},{key:"getEventType",value:function(){return"cancel"}},{key:"getEventRunner",value:function(){return this.eventRegistration.getEventRunner(this)}},{key:"toString",value:function(){return this.path.toString()+":cancel"}}]),t}(),wp=function(){"use strict";function t(n,r){e(u)(this,t),this.snapshotCallback=n,this.cancelCallback=r}return e(c)(t,[{key:"onValue",value:function(e,t){this.snapshotCallback.call(null,e,t)}},{key:"onCancel",value:function(e){return U(this.hasCancelCallback,"Raising a cancel event on a listener with no cancel callback"),this.cancelCallback.call(null,e)}},{key:"hasCancelCallback",get:function(){return!!this.cancelCallback}},{key:"matches",value:function(e){return this.snapshotCallback===e.snapshotCallback||void 0!==this.snapshotCallback.userCallback&&this.snapshotCallback.userCallback===e.snapshotCallback.userCallback&&this.snapshotCallback.context===e.snapshotCallback.context}}]),t}(),Ip=function(){"use strict";function t(n,r,i,a){e(u)(this,t),this._repo=n,this._path=r,this._queryParams=i,this._orderByCalled=a}return e(c)(t,[{key:"key",get:function(){return ml(this._path)?null:dl(this._path)}},{key:"ref",get:function(){return new xp(this._repo,this._path)}},{key:"_queryIdentifier",get:function(){var e=vh(this._queryParams),t=Pc(e);return"{}"===t?"default":t}},{key:"_queryObject",get:function(){return vh(this._queryParams)}},{key:"isEqual",value:function(e){if(!((e=Le(e))instanceof t))return!1;var n=this._repo===e._repo,r=_l(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&r&&i}},{key:"toJSON",value:function(){return this.toString()}},{key:"toString",value:function(){return this._repo.toString()+function(e){for(var t="",n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}}]),t}();var xp=function(t){"use strict";e(l)(r,t);var n=e(I)(r);function r(t,i){return e(u)(this,r),n.call(this,t,i,new dh,!1)}return e(c)(r,[{key:"parent",get:function(){var e=vl(this._path);return null===e?null:new r(this._repo,e)}},{key:"root",get:function(){for(var e=this;null!==e.parent;)e=e.parent;return e}}]),r}(Ip),Cp=function(){"use strict";function t(n,r,i){e(u)(this,t),this._node=n,this.ref=r,this._index=i}return e(c)(t,[{key:"priority",get:function(){return this._node.getPriority().val()}},{key:"key",get:function(){return this.ref.key}},{key:"size",get:function(){return this._node.numChildren()}},{key:"child",value:function(e){var n=new ul(e),r=Ep(this.ref,e);return new t(this._node.getChild(n),r,Yl)}},{key:"exists",value:function(){return!this._node.isEmpty()}},{key:"exportVal",value:function(){return this._node.val(!0)}},{key:"forEach",value:function(e){var n=this;return!this._node.isLeafNode()&&!!this._node.forEachChild(this._index,(function(r,i){return e(new t(i,Ep(n.ref,r),Yl))}))}},{key:"hasChild",value:function(e){var t=new ul(e);return!this._node.getChild(t).isEmpty()}},{key:"hasChildren",value:function(){return!this._node.isLeafNode()&&!this._node.isEmpty()}},{key:"toJSON",value:function(){return this.exportVal()}},{key:"val",value:function(){return this._node.val()}}]),t}();function Tp(e,t){return(e=Le(e))._checkNotDeleted("ref"),void 0!==t?Ep(e._root,t):e._root}function Ep(e,t){var n,r,i,a;return null===ll((e=Le(e))._path)?(n="child",r="path",a=!1,(i=t)&&(i=i.replace(/^\/*\.info(\/|$)/,"/")),jd(n,r,i,a)):jd("child","path",t,!1),new xp(e._repo,yl(e._path,t))}function Sp(e,t){e=Le(e),Ud("set",e._path),Ld("set",t,e._path,!1);var n=new te;return tp(e._repo,e._path,t,null,n.wrapCallback((function(){}))),n.promise}function Pp(e){e=Le(e);var t,n,r,i,a=new wp((function(){})),o=new Np(a);return(t=e._repo,n=e,r=o,i=Zf(t.serverSyncTree_,n),null!=i?Promise.resolve(i):t.server_.get(n).then((function(e){var i,a=nh(e).withIndex(n._queryParams.getIndex());if($f(t.serverSyncTree_,n,r,!0),n._queryParams.loadsAllData())i=Yf(t.serverSyncTree_,n._path,a);else{var o=id(t.serverSyncTree_,n);i=Qf(t.serverSyncTree_,n._path,a,o)}return Hd(t.eventQueue_,n._path,i),Jf(t.serverSyncTree_,n,r,null,!0),a}),(function(e){return rp(t,"get for query "+ye(n)+" failed: "+e),Promise.reject(new Error(e))}))).then((function(t){return new Cp(t,new xp(e._repo,e._path),e._queryParams.getIndex())}))}var Np=function(){"use strict";function t(n){e(u)(this,t),this.callbackContext=n}return e(c)(t,[{key:"respondsTo",value:function(e){return"value"===e}},{key:"createEvent",value:function(e,t){var n=t._queryParams.getIndex();return new kp("value",this,new Cp(e.snapshotNode,new xp(t._repo,t._path),n))}},{key:"getEventRunner",value:function(e){var t=this;return"cancel"===e.getEventType()?function(){return t.callbackContext.onCancel(e.error)}:function(){return t.callbackContext.onValue(e.snapshot,null)}}},{key:"createCancelEvent",value:function(e,t){return this.callbackContext.hasCancelCallback?new bp(this,e,t):null}},{key:"matches",value:function(e){return e instanceof t&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}},{key:"hasAnyCallback",value:function(){return null!==this.callbackContext}}]),t}();!function(e){U(!xf,"__referenceConstructor has already been defined"),xf=e}(xp),function(e){U(!Rf,"__referenceConstructor has already been defined"),Rf=e}(xp);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var Rp={},Op=!1;function Ap(e,t,n,r){e.repoInfo_=new Bc("".concat(t,":").concat(n),!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams,!0),r&&(e.authTokenProvider_=r)}function Dp(e,t,n,r,i){var a=r||e.options.databaseURL;void 0===a&&(e.options.projectId||bc("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),gc("Using default host for project ",e.options.projectId),a="".concat(e.options.projectId,"-default-rtdb.firebaseio.com"));var o,s=mp(a,i),u=s.repoInfo,c=void 0;void 0!==k&&k.env&&(c=k.env.FIREBASE_DATABASE_EMULATOR_HOST),c?(o=!0,a="http://".concat(c,"?ns=").concat(u.namespace),u=(s=mp(a,i)).repoInfo):o=!s.repoInfo.secure;var l=i&&o?new Uc(Uc.OWNER):new jc(e.name,e.options,t);qd("Invalid Firebase Database URL",s),ml(s.path)||bc("Database URL must point to the root of a Firebase Database (not including a child path).");var h=function(e,t,n,r){var i=Rp[t.name];i||(i={},Rp[t.name]=i);var a=i[e.toURLString()];a&&bc("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return a=new Gd(e,Op,n,r),i[e.toURLString()]=a,a}(u,e,l,new Fc(e.name,n));return new Mp(h,e)}var Mp=function(){"use strict";function t(n,r){e(u)(this,t),this._repoInternal=n,this.app=r,this.type="database",this._instanceStarted=!1}return e(c)(t,[{key:"_repo",get:function(){return this._instanceStarted||(Yd(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}},{key:"_root",get:function(){return this._rootInternal||(this._rootInternal=new xp(this._repo,cl())),this._rootInternal}},{key:"_delete",value:function(){var e,t,n;return null!==this._rootInternal&&(e=this._repo,t=this.app.name,(n=Rp[t])&&n[e.key]===e||bc("Database ".concat(t,"(").concat(e.repoInfo_,") has already been deleted.")),np(e),delete n[e.key],this._repoInternal=null,this._rootInternal=null),Promise.resolve()}},{key:"_checkNotDeleted",value:function(e){null===this._rootInternal&&bc("Cannot call "+e+" on a deleted database.")}}]),t}();function Lp(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Mt(),n=arguments.length>1?arguments[1]:void 0,r=Pt(t,"database").getImmediate({identifier:n});if(!r._instanceStarted){var i=X("database");i&&Fp.apply(void 0,[r].concat(e(f)(i)))}return r}function Fp(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:{};(e=Le(e))._checkNotDeleted("useEmulator"),e._instanceStarted&&bc("Cannot call useEmulator() after instance has already been initialized.");var i=e._repoInternal,a=void 0;if(i.repoInfo_.nodeAdmin)r.mockUserToken&&bc('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),a=new Uc(Uc.OWNER);else if(r.mockUserToken){var o="string"==typeof r.mockUserToken?r.mockUserToken:ne(r.mockUserToken,e.app.options.projectId);a=new Uc(o)}Ap(i,t,n,a)}Tl.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Tl.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){ic=At,St(new je("database",(function(e,t){var n=t.instanceIdentifier;return Dp(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),n)}),"PUBLIC").setMultipleInstances(!0)),Lt(nc,rc,e),Lt(nc,rc,"esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();var jp=document.querySelector(".backdrop"),Up=document.querySelector(".open-modal"),qp=document.querySelector(".form-wrapper"),Wp=document.querySelector(".display-shop");Wp.style.display="none";var Vp=null,Hp=Dt({apiKey:"AIzaSyBoP3LpsEiKYieYZusHkpDBfoZn6Hezx9o",authDomain:"serhii-df24d.firebaseapp.com",projectId:"serhii-df24d",storageBucket:"serhii-df24d.appspot.com",messagingSenderId:"305658302139",appId:"1:305658302139:web:6a7f5004932c7c8c1f639e",measurementId:"G-WNMLVDPVC8"}),Bp=(function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Mt(),t=Pt(e=Le(e),au);t.isInitialized()?t.getImmediate():$u(e)}(Hp),function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Mt(),t=Pt(e,"auth");if(t.isInitialized())return t.getImmediate();var n=jr(e,{popupRedirectResolver:po,persistence:[ha,qi,Vi]}),r=ee("authTokenSyncURL");if(r){var i=To(r);Di(n,i,(function(){return i(n.currentUser)})),Ai(n,(function(e){return i(e)}))}var a=$("auth");return a&&Ur(n,"http://".concat(a)),n}(Hp));function zp(){var e;(e=Bp,Le(e).signOut()).then((function(){Vp.remove(),Up.textContent="Sign up",Up.disabled=!1,Wp.style.display="none"})).catch((function(e){}))}function Kp(e){e.preventDefault();var t=e.currentTarget.elements,n=t.name,r=t.email,i=t.password;Ni(Bp,r.value,i.value).then((function(e){e.user;!function(e){Sp(Tp(Lp(),"users/"+Bp.currentUser.uid),{name:e})}(n.value),jp.classList.add("is-hidden"),Jp()})).catch((function(e){e.code,e.message}))}function Gp(e){return Yp.apply(this,arguments)}function Yp(){return(Yp=e(a)(e(o).mark((function t(n){var r,i,a;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n.preventDefault(),r=n.currentTarget.elements,i=r.email,a=r.password,e.next=4,Oi(Bp,i.value,a.value).then((function(e){e.user;Jp(),jp.classList.add("is-hidden")})).catch((function(e){e.code,e.message}));case 4:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Jp(){Pp(Ep(Tp(Lp()),"users/".concat(Bp.currentUser.uid))).then((function(e){e.exists()&&(Up.textContent=e.val().name,Wp.style.display="block")})).catch((function(e){}))}document.querySelector(".cloze").addEventListener("click",(function(){jp.classList.add("is-hidden")}));var Qp,$p,Xp,Zp=document.querySelector(".sign-in"),ev=document.querySelector(".sign-up");function tv(){if("Sign up"!==Up.textContent)return function(){var e='<button class="log-out">Log out</button>';Up.insertAdjacentHTML("afterend",e),(Vp=document.querySelector(".log-out")).addEventListener("click",zp)}(),void(Up.disabled=!0);qp.innerHTML='<form class="auth-form">\n  <input type="text" name="name" placeholder="NAME" />\n  <input type="text" name="email" placeholder="EMAIL" />\n  <input type="text" name="password" placeholder="PASSWORD" />\n  <button type="submit" class="registr">SIGN UP</button>\n  </form>';var e=document.querySelector(".auth-form");jp.classList.remove("is-hidden"),e.addEventListener("submit",Kp)}Up.addEventListener("click",tv),ev.addEventListener("click",tv),Zp.addEventListener("click",(function(){qp.innerHTML='<form class="login-form">\n  <input type="text" name="email" placeholder="EMAIL" />\n  <input type="text" name="password" placeholder="PASSWORD" />\n  <button type="submit" class="login">LOGIN</button>\n  </form>',document.querySelector(".login-form").addEventListener("submit",Gp)})),Qp=function(e){e&&(e.uid,Jp())},Le(Bp).onAuthStateChanged(Qp,$p,Xp)}();
//# sourceMappingURL=shopping.83339a75.js.map
